...
class tetranyte_im(pluginTemplate):
    __model__ = "tetranyte_im-rv32i"
    __version__ = "0.1"
    ...
    def __init__(self, *args, **kwargs):
        ...
        if config is None:
            raise SystemExit("tetranyte_im plugin requires configuration")

        sim_name = config.get("sim", "tetranyte_im_sim")
