...
class zeronyte_zmmul(pluginTemplate):
    __model__ = "zeronyte_zmmul-rv32i"
    __version__ = "0.1"
    ...
    def __init__(self, *args, **kwargs):
        ...
        if config is None:
            raise SystemExit("zeronyte_zmmul plugin requires configuration")

        sim_name = config.get("sim", "zeronyte_zmmul_sim")
