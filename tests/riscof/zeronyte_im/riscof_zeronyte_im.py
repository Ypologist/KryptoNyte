...
class zeronyte_im(pluginTemplate):
    __model__ = "zeronyte_im-rv32im"
    __version__ = "0.1"
    ...
    def __init__(self, *args, **kwargs):
        ...
        if config is None:
            raise SystemExit("zeronyte_im plugin requires configuration")

        sim_name = config.get("sim", "zeronyte_im_sim")
