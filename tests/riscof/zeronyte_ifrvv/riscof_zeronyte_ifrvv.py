...
class zeronyte_ifrvv(pluginTemplate):
    __model__ = "zeronyte_ifrvv-rv32if"
    __version__ = "0.1"
    ...
    def __init__(self, *args, **kwargs):
        ...
        if config is None:
            raise SystemExit("zeronyte_ifrvv plugin requires configuration")

        sim_name = config.get("sim", "zeronyte_ifrvv_sim")
