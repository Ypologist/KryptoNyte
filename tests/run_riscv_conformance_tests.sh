...
AVAILABLE_PROCESSORS=(
  ...
  "tetranyte|tetranyte|sim/build_tetranyte_sim.sh|tetranyte_sim|tetranyte/tetranyte_isa.yaml|tetranyte/tetranyte_platform.yaml|rtl/generators/generated_sim/verilog_hierarchical_timed/TetraNyteRV32ICore.v|generators/runMain generators.GenerateHierarchicalRTL --core-family TetraNyte --core-variant rv32i --cosimulate|i"
  "tetranyte-im|tetranyte_im|sim/build_tetranyte_im_sim.sh|tetranyte_im_sim|tetranyte_im/tetranyte_im_isa.yaml|tetranyte_im/tetranyte_im_platform.yaml|rtl/generators/generated_sim/verilog_hierarchical_timed/TetraNyteRV32IMCore.v|generators/runMain generators.GenerateHierarchicalRTL --core-family TetraNyte --core-variant rv32im --cosimulate|im"
  "tetranyte-zmmul|tetranyte_zmmul|sim/build_tetranyte_zmmul_sim.sh|tetranyte_zmmul_sim|tetranyte_zmmul/tetranyte_zmmul_isa.yaml|tetranyte_zmmul/tetranyte_zmmul_platform.yaml|rtl/generators/generated_sim/verilog_hierarchical_timed/TetraNyteRV32IZmmulCore.v|generators/runMain generators.GenerateHierarchicalRTL --core-family TetraNyte --core-variant rv32i_Zmmul --cosimulate|zmmul"
  "octonyte-zmmul|octonyte_zmmul|sim/build_octonyte_zmmul_sim.sh|octonyte_zmmul_sim|octonyte_zmmul/octonyte_zmmul_isa.yaml|octonyte_zmmul/octonyte_zmmul_platform.yaml|rtl/generators/generated_sim/verilog_hierarchical_timed/OctoNyteRV32IZmmulCore.v|generators/runMain generators.GenerateHierarchicalRTL --core-family OctoNyte --core-variant rv32i_Zmmul --cosimulate|zmmul"
  "zeronyte|zeronyte|sim/build_zeronyte_sim.sh|zeronyte_sim|zeronyte/zeronyte_isa.yaml|zeronyte/zeronyte_platform.yaml|rtl/generators/generated_sim/verilog_hierarchical_timed/ZeroNyteRV32ICore.v|generators/runMain generators.GenerateHierarchicalRTL --core-family ZeroNyte --core-variant rv32i --cosimulate|i"
