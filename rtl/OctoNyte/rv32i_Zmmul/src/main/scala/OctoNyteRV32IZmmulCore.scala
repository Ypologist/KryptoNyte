...
// Core IO Definition
// *********************************************************
class OctoNyteRV32IZmmulCoreIO(val numThreads: Int, val fetchWidth: Int) extends Bundle {
...
// *********************************************************
class OctoNyteRV32IZmmulCore extends Module {
  val numThreads = 8
  ...
  val io = IO(new OctoNyteRV32IZmmulCoreIO(numThreads, fetchWidth))
