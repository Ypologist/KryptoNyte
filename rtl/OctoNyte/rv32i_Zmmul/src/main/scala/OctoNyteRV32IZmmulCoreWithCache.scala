...
// *********************************************************
class OctoNyteRV32IZmmulCoreWithCacheIO(val numThreads: Int, val fetchWidth: Int) extends Bundle {
...
// *********************************************************
class OctoNyteRV32IZmmulCoreWithCache extends Module {
  val numThreads = 8
  ...
  val io = IO(new OctoNyteRV32IZmmulCoreWithCacheIO(numThreads, fetchWidth))
