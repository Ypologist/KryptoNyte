...
// *********************************************************
class OctoNyteRV32IMCoreWithCacheIO(val numThreads: Int, val fetchWidth: Int) extends Bundle {
...
// *********************************************************
class OctoNyteRV32IMCoreWithCache extends Module {
  val numThreads = 8
  ...
  val io = IO(new OctoNyteRV32IMCoreWithCacheIO(numThreads, fetchWidth))
