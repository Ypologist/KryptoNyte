...
// *********************************************************
class OctoNyteRV32IMCoreWithCacheIO(val numThreads: Int, val fetchWidth: Int, val cosimulate: Boolean = false) extends Bundle {
...
// *********************************************************
class OctoNyteRV32IMCoreWithCache(val cosimulate: Boolean = false) extends Module {
  val numThreads = 8
