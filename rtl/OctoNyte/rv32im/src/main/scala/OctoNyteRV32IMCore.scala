...
// Core IO Definition
// *********************************************************
class OctoNyteRV32IMCoreIO(val numThreads: Int, val fetchWidth: Int) extends Bundle {
...
// *********************************************************
class OctoNyteRV32IMCore extends Module {
  val numThreads = 8
  ...
  val io = IO(new OctoNyteRV32IMCoreIO(numThreads, fetchWidth))
