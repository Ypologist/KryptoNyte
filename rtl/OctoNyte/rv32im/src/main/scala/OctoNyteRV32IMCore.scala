...
// Core IO Definition
// *********************************************************
class OctoNyteRV32IMCoreIO(val numThreads: Int, val fetchWidth: Int, val cosimulate: Boolean = false) extends Bundle {
...
// *********************************************************
class OctoNyteRV32IMCore(val cosimulate: Boolean = false) extends Module {
  val numThreads = 8
  ...
  val io = IO(new OctoNyteRV32IMCoreIO(numThreads, fetchWidth, cosimulate))
  io.jtag_tdo := 0.U
