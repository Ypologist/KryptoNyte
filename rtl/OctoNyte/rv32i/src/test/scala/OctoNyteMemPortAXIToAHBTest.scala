...
class OctoNyteMemPortAXIToAHBTest extends AnyFlatSpec {
  "OctoNyteMemPort + TL->AXI4-Lite->AHB-Lite" should "store then load the same word" in {
    class Harness extends Module {
      ...
      val mp = Module(new OctoNyteMemPort())
