...
class TetraNyteRV32IZmmulCoreWithCacheIO(val numThreads: Int) extends Bundle {
...
class TetraNyteRV32IZmmulCoreWithCache extends Module {
  val numThreads = 4
  val io = IO(new TetraNyteRV32IZmmulCoreWithCacheIO(numThreads))
