module {
  firrtl.circuit "OctoNyteRV32IZmmulCore" {
    ...
    firrtl.module @OctoNyteRV32IZmmulCore(in %clock: !firrtl.clock, in %reset: !firrtl.uint<1>, in %io_threadEnable: !firrtl.vector<uint<1>, 8>, in %io_instrMem: !firrtl.uint<128>, in %io_dataMemResp: !firrtl.uint<32>, out %io_memAddr: !firrtl.uint<32>, out %io_memWrite: !firrtl.uint<32>, out %io_memMask: !firrtl.uint<4>, out %io_memValid: !firrtl.uint<1>, out %io_memMisaligned: !firrtl.uint<1>, out %io_debugStageThreads: !firrtl.vector<uint<3>, 8>, out %io_debugStageValids: !firrtl.vector<uint<1>, 8>, out %io_debugPC: !firrtl.vector<uint<32>, 8>, out %io_debugRegs01234: !firrtl.vector<vector<uint<32>, 5>, 8>, out %io_debugRegX1: !firrtl.vector<uint<32>, 8>, out %io_debugCtrlValid: !firrtl.uint<1>, out %io_debugCtrlInstr: !firrtl.uint<32>, out %io_debugCtrlTaken: !firrtl.uint<1>, out %io_debugCtrlThread: !firrtl.uint<3>, out %io_debugCtrlFromPC: !firrtl.uint<32>, out %io_debugCtrlTarget: !firrtl.uint<32>, out %io_debugCtrlIsBranch: !firrtl.uint<1>, out %io_debugCtrlIsJal: !firrtl.uint<1>, out %io_debugCtrlIsJalr: !firrtl.uint<1>, out %io_debugExecValid: !firrtl.uint<1>, out %io_debugExecThread: !firrtl.uint<3>, out %io_debugExecPC: !firrtl.uint<32>, out %io_debugExecInstr: !firrtl.uint<32>, out %io_debugExecIsBranch: !firrtl.uint<1>, out %io_debugExecIsJal: !firrtl.uint<1>, out %io_debugExecIsJalr: !firrtl.uint<1>, out %io_debugExecBranchOp: !firrtl.uint<3>, out %io_debugExecRs1: !firrtl.uint<32>, out %io_debugExecRs2: !firrtl.uint<32>, out %io_debugExecCtrlTaken: !firrtl.uint<1>, out %io_debugExecCtrlTarget: !firrtl.uint<32>, in %io_jtag_tck: !firrtl.uint<0>, in %io_jtag_tms: !firrtl.uint<0>, in %io_jtag_tdi: !firrtl.uint<0>, out %io_jtag_tdo: !firrtl.uint<0>, in %io_jtag_trst_n: !firrtl.uint<0>) {
      ...
      %c0_ui4 = firrtl.constant 0 : !firrtl.uint<4>
      %c0_ui0 = firrtl.constant 0 : !firrtl.uint<0> {name = "io_jtag_tdo"}
      %c0_ui2 = firrtl.constant 0 : !firrtl.uint<2>
      ...
      %io_debugStageThreads_6 = firrtl.wire {name = "io_debugStageThreads"} : !firrtl.vector<uint<3>, 8>
      %io_debugStageValids_7 = firrtl.wire {name = "io_debugStageValids"} : !firrtl.vector<uint<1>, 8>
      %io_debugPC_8 = firrtl.wire {name = "io_debugPC"} : !firrtl.vector<uint<32>, 8>
      %io_debugRegs01234_9 = firrtl.wire {name = "io_debugRegs01234"} : !firrtl.vector<vector<uint<32>, 5>, 8>
      %io_debugRegX1_10 = firrtl.wire {name = "io_debugRegX1"} : !firrtl.vector<uint<32>, 8>
      %io_debugCtrlValid_11 = firrtl.wire {name = "io_debugCtrlValid"} : !firrtl.uint<1>
      %io_debugCtrlInstr_12 = firrtl.wire {name = "io_debugCtrlInstr"} : !firrtl.uint<32>
      %io_debugCtrlTaken_13 = firrtl.wire {name = "io_debugCtrlTaken"} : !firrtl.uint<1>
      %io_debugCtrlThread_14 = firrtl.wire {name = "io_debugCtrlThread"} : !firrtl.uint<3>
      %io_debugCtrlFromPC_15 = firrtl.wire {name = "io_debugCtrlFromPC"} : !firrtl.uint<32>
      %io_debugCtrlTarget_16 = firrtl.wire {name = "io_debugCtrlTarget"} : !firrtl.uint<32>
      %io_debugCtrlIsBranch_17 = firrtl.wire {name = "io_debugCtrlIsBranch"} : !firrtl.uint<1>
      %io_debugCtrlIsJal_18 = firrtl.wire {name = "io_debugCtrlIsJal"} : !firrtl.uint<1>
      %io_debugCtrlIsJalr_19 = firrtl.wire {name = "io_debugCtrlIsJalr"} : !firrtl.uint<1>
      ...
      firrtl.matchingconnect %io_debugStageThreads, %io_debugStageThreads_6 : !firrtl.vector<uint<3>, 8>
      firrtl.matchingconnect %io_debugStageValids, %io_debugStageValids_7 : !firrtl.vector<uint<1>, 8>
      firrtl.matchingconnect %io_debugPC, %io_debugPC_8 : !firrtl.vector<uint<32>, 8>
      firrtl.matchingconnect %io_debugRegX1, %io_debugRegX1_10 : !firrtl.vector<uint<32>, 8>
      firrtl.matchingconnect %io_debugCtrlValid, %io_debugCtrlValid_11 : !firrtl.uint<1>
      firrtl.matchingconnect %io_debugCtrlInstr, %io_debugCtrlInstr_12 : !firrtl.uint<32>
      firrtl.matchingconnect %io_debugCtrlTaken, %io_debugCtrlTaken_13 : !firrtl.uint<1>
      firrtl.matchingconnect %io_debugCtrlThread, %io_debugCtrlThread_14 : !firrtl.uint<3>
      firrtl.matchingconnect %io_debugCtrlFromPC, %io_debugCtrlFromPC_15 : !firrtl.uint<32>
      firrtl.matchingconnect %io_debugCtrlTarget, %io_debugCtrlTarget_16 : !firrtl.uint<32>
      firrtl.matchingconnect %io_debugCtrlIsBranch, %io_debugCtrlIsBranch_17 : !firrtl.uint<1>
      firrtl.matchingconnect %io_debugCtrlIsJal, %io_debugCtrlIsJal_18 : !firrtl.uint<1>
      firrtl.matchingconnect %io_debugCtrlIsJalr, %io_debugCtrlIsJalr_19 : !firrtl.uint<1>
      firrtl.matchingconnect %io_debugExecValid, %c0_ui1 : !firrtl.uint<1>
      firrtl.matchingconnect %io_debugExecThread, %c0_ui3 : !firrtl.uint<3>
      firrtl.matchingconnect %io_debugExecPC, %c0_ui32 : !firrtl.uint<32>
      firrtl.matchingconnect %io_debugExecInstr, %c0_ui32 : !firrtl.uint<32>
      firrtl.matchingconnect %io_debugExecIsBranch, %c0_ui1 : !firrtl.uint<1>
      firrtl.matchingconnect %io_debugExecIsJal, %c0_ui1 : !firrtl.uint<1>
      firrtl.matchingconnect %io_debugExecIsJalr, %c0_ui1 : !firrtl.uint<1>
      firrtl.matchingconnect %io_debugExecBranchOp, %c0_ui3 : !firrtl.uint<3>
      firrtl.matchingconnect %io_debugExecRs1, %c0_ui32 : !firrtl.uint<32>
      firrtl.matchingconnect %io_debugExecRs2, %c0_ui32 : !firrtl.uint<32>
      firrtl.matchingconnect %io_debugExecCtrlTaken, %c0_ui1 : !firrtl.uint<1>
      firrtl.matchingconnect %io_debugExecCtrlTarget, %c0_ui32 : !firrtl.uint<32>
      firrtl.matchingconnect %io_jtag_tdo, %c0_ui0 : !firrtl.uint<0>
      ...
      %18 = firrtl.subindex %debugRegs1to4[0] : !firrtl.vector<vector<uint<32>, 4>, 8>
      %19 = firrtl.subindex %18[0] : !firrtl.vector<uint<32>, 4>
      %20 = firrtl.subindex %18[1] : !firrtl.vector<uint<32>, 4>
      %21 = firrtl.subindex %18[2] : !firrtl.vector<uint<32>, 4>
      %22 = firrtl.subindex %18[3] : !firrtl.vector<uint<32>, 4>
      %23 = firrtl.subindex %debugRegs1to4[1] : !firrtl.vector<vector<uint<32>, 4>, 8>
      %24 = firrtl.subindex %23[0] : !firrtl.vector<uint<32>, 4>
      %25 = firrtl.subindex %23[1] : !firrtl.vector<uint<32>, 4>
      %26 = firrtl.subindex %23[2] : !firrtl.vector<uint<32>, 4>
      %27 = firrtl.subindex %23[3] : !firrtl.vector<uint<32>, 4>
      %28 = firrtl.subindex %debugRegs1to4[2] : !firrtl.vector<vector<uint<32>, 4>, 8>
      %29 = firrtl.subindex %28[0] : !firrtl.vector<uint<32>, 4>
      %30 = firrtl.subindex %28[1] : !firrtl.vector<uint<32>, 4>
      %31 = firrtl.subindex %28[2] : !firrtl.vector<uint<32>, 4>
      %32 = firrtl.subindex %28[3] : !firrtl.vector<uint<32>, 4>
      %33 = firrtl.subindex %debugRegs1to4[3] : !firrtl.vector<vector<uint<32>, 4>, 8>
      %34 = firrtl.subindex %33[0] : !firrtl.vector<uint<32>, 4>
      %35 = firrtl.subindex %33[1] : !firrtl.vector<uint<32>, 4>
      %36 = firrtl.subindex %33[2] : !firrtl.vector<uint<32>, 4>
      %37 = firrtl.subindex %33[3] : !firrtl.vector<uint<32>, 4>
      %38 = firrtl.subindex %debugRegs1to4[4] : !firrtl.vector<vector<uint<32>, 4>, 8>
      %39 = firrtl.subindex %38[0] : !firrtl.vector<uint<32>, 4>
      %40 = firrtl.subindex %38[1] : !firrtl.vector<uint<32>, 4>
      %41 = firrtl.subindex %38[2] : !firrtl.vector<uint<32>, 4>
      %42 = firrtl.subindex %38[3] : !firrtl.vector<uint<32>, 4>
      %43 = firrtl.subindex %debugRegs1to4[5] : !firrtl.vector<vector<uint<32>, 4>, 8>
      %44 = firrtl.subindex %43[0] : !firrtl.vector<uint<32>, 4>
      %45 = firrtl.subindex %43[1] : !firrtl.vector<uint<32>, 4>
      %46 = firrtl.subindex %43[2] : !firrtl.vector<uint<32>, 4>
      %47 = firrtl.subindex %43[3] : !firrtl.vector<uint<32>, 4>
      %48 = firrtl.subindex %debugRegs1to4[6] : !firrtl.vector<vector<uint<32>, 4>, 8>
      %49 = firrtl.subindex %48[0] : !firrtl.vector<uint<32>, 4>
      %50 = firrtl.subindex %48[1] : !firrtl.vector<uint<32>, 4>
      %51 = firrtl.subindex %48[2] : !firrtl.vector<uint<32>, 4>
      %52 = firrtl.subindex %48[3] : !firrtl.vector<uint<32>, 4>
      %53 = firrtl.subindex %debugRegs1to4[7] : !firrtl.vector<vector<uint<32>, 4>, 8>
      %54 = firrtl.subindex %53[0] : !firrtl.vector<uint<32>, 4>
      %55 = firrtl.subindex %53[1] : !firrtl.vector<uint<32>, 4>
      %56 = firrtl.subindex %53[2] : !firrtl.vector<uint<32>, 4>
      %57 = firrtl.subindex %53[3] : !firrtl.vector<uint<32>, 4>
      %58 = firrtl.subindex %debugRegs1to4[7] : !firrtl.vector<vector<uint<32>, 4>, 8>
      %59 = firrtl.subindex %58[3] : !firrtl.vector<uint<32>, 4>
      %60 = firrtl.subindex %58[2] : !firrtl.vector<uint<32>, 4>
      %61 = firrtl.subindex %58[1] : !firrtl.vector<uint<32>, 4>
      %62 = firrtl.subindex %58[0] : !firrtl.vector<uint<32>, 4>
      %63 = firrtl.subindex %debugRegs1to4[6] : !firrtl.vector<vector<uint<32>, 4>, 8>
      %64 = firrtl.subindex %63[3] : !firrtl.vector<uint<32>, 4>
      %65 = firrtl.subindex %63[2] : !firrtl.vector<uint<32>, 4>
      %66 = firrtl.subindex %63[1] : !firrtl.vector<uint<32>, 4>
      %67 = firrtl.subindex %63[0] : !firrtl.vector<uint<32>, 4>
      %68 = firrtl.subindex %debugRegs1to4[5] : !firrtl.vector<vector<uint<32>, 4>, 8>
      %69 = firrtl.subindex %68[3] : !firrtl.vector<uint<32>, 4>
      %70 = firrtl.subindex %68[2] : !firrtl.vector<uint<32>, 4>
      %71 = firrtl.subindex %68[1] : !firrtl.vector<uint<32>, 4>
      %72 = firrtl.subindex %68[0] : !firrtl.vector<uint<32>, 4>
      %73 = firrtl.subindex %debugRegs1to4[4] : !firrtl.vector<vector<uint<32>, 4>, 8>
      %74 = firrtl.subindex %73[3] : !firrtl.vector<uint<32>, 4>
      %75 = firrtl.subindex %73[2] : !firrtl.vector<uint<32>, 4>
      %76 = firrtl.subindex %73[1] : !firrtl.vector<uint<32>, 4>
      %77 = firrtl.subindex %73[0] : !firrtl.vector<uint<32>, 4>
      %78 = firrtl.subindex %debugRegs1to4[3] : !firrtl.vector<vector<uint<32>, 4>, 8>
      %79 = firrtl.subindex %78[3] : !firrtl.vector<uint<32>, 4>
      %80 = firrtl.subindex %78[2] : !firrtl.vector<uint<32>, 4>
      %81 = firrtl.subindex %78[1] : !firrtl.vector<uint<32>, 4>
      %82 = firrtl.subindex %78[0] : !firrtl.vector<uint<32>, 4>
      %83 = firrtl.subindex %debugRegs1to4[2] : !firrtl.vector<vector<uint<32>, 4>, 8>
      %84 = firrtl.subindex %83[3] : !firrtl.vector<uint<32>, 4>
      %85 = firrtl.subindex %83[2] : !firrtl.vector<uint<32>, 4>
      %86 = firrtl.subindex %83[1] : !firrtl.vector<uint<32>, 4>
      %87 = firrtl.subindex %83[0] : !firrtl.vector<uint<32>, 4>
      %88 = firrtl.subindex %debugRegs1to4[1] : !firrtl.vector<vector<uint<32>, 4>, 8>
      %89 = firrtl.subindex %88[3] : !firrtl.vector<uint<32>, 4>
      %90 = firrtl.subindex %88[2] : !firrtl.vector<uint<32>, 4>
      %91 = firrtl.subindex %88[1] : !firrtl.vector<uint<32>, 4>
      %92 = firrtl.subindex %88[0] : !firrtl.vector<uint<32>, 4>
      %93 = firrtl.subindex %debugRegs1to4[0] : !firrtl.vector<vector<uint<32>, 4>, 8>
      %94 = firrtl.subindex %93[3] : !firrtl.vector<uint<32>, 4>
      %95 = firrtl.subindex %93[2] : !firrtl.vector<uint<32>, 4>
      %96 = firrtl.subindex %93[1] : !firrtl.vector<uint<32>, 4>
      %97 = firrtl.subindex %93[0] : !firrtl.vector<uint<32>, 4>
      ...
      %98 = firrtl.subfield %regFile.io[readThreadID] : !firrtl.bundle<readThreadID: vector<uint<3>, 8>, src1: vector<uint<5>, 8>, src2: vector<uint<5>, 8>, src1data: vector<uint<32>, 8>, src2data: vector<uint<32>, 8>, writeThreadID: vector<uint<3>, 4>, dst: vector<uint<5>, 4>, wen: vector<uint<1>, 4>, dstData: vector<uint<32>, 4>, debugX1: vector<uint<32>, 8>, debugRegs01234: vector<vector<uint<32>, 5>, 8>>
      firrtl.matchingconnect %regFile_io_readThreadID, %98 : !firrtl.vector<uint<3>, 8>
      %99 = firrtl.subfield %regFile.io[src1] : !firrtl.bundle<readThreadID: vector<uint<3>, 8>, src1: vector<uint<5>, 8>, src2: vector<uint<5>, 8>, src1data: vector<uint<32>, 8>, src2data: vector<uint<32>, 8>, writeThreadID: vector<uint<3>, 4>, dst: vector<uint<5>, 4>, wen: vector<uint<1>, 4>, dstData: vector<uint<32>, 4>, debugX1: vector<uint<32>, 8>, debugRegs01234: vector<vector<uint<32>, 5>, 8>>
      firrtl.matchingconnect %regFile_io_src1, %99 : !firrtl.vector<uint<5>, 8>
      %100 = firrtl.subfield %regFile.io[src2] : !firrtl.bundle<readThreadID: vector<uint<3>, 8>, src1: vector<uint<5>, 8>, src2: vector<uint<5>, 8>, src1data: vector<uint<32>, 8>, src2data: vector<uint<32>, 8>, writeThreadID: vector<uint<3>, 4>, dst: vector<uint<5>, 4>, wen: vector<uint<1>, 4>, dstData: vector<uint<32>, 4>, debugX1: vector<uint<32>, 8>, debugRegs01234: vector<vector<uint<32>, 5>, 8>>
      firrtl.matchingconnect %regFile_io_src2, %100 : !firrtl.vector<uint<5>, 8>
      %101 = firrtl.subfield %regFile.io[src1data] : !firrtl.bundle<readThreadID: vector<uint<3>, 8>, src1: vector<uint<5>, 8>, src2: vector<uint<5>, 8>, src1data: vector<uint<32>, 8>, src2data: vector<uint<32>, 8>, writeThreadID: vector<uint<3>, 4>, dst: vector<uint<5>, 4>, wen: vector<uint<1>, 4>, dstData: vector<uint<32>, 4>, debugX1: vector<uint<32>, 8>, debugRegs01234: vector<vector<uint<32>, 5>, 8>>
      %102 = firrtl.subfield %regFile.io[src2data] : !firrtl.bundle<readThreadID: vector<uint<3>, 8>, src1: vector<uint<5>, 8>, src2: vector<uint<5>, 8>, src1data: vector<uint<32>, 8>, src2data: vector<uint<32>, 8>, writeThreadID: vector<uint<3>, 4>, dst: vector<uint<5>, 4>, wen: vector<uint<1>, 4>, dstData: vector<uint<32>, 4>, debugX1: vector<uint<32>, 8>, debugRegs01234: vector<vector<uint<32>, 5>, 8>>
      %103 = firrtl.subfield %regFile.io[writeThreadID] : !firrtl.bundle<readThreadID: vector<uint<3>, 8>, src1: vector<uint<5>, 8>, src2: vector<uint<5>, 8>, src1data: vector<uint<32>, 8>, src2data: vector<uint<32>, 8>, writeThreadID: vector<uint<3>, 4>, dst: vector<uint<5>, 4>, wen: vector<uint<1>, 4>, dstData: vector<uint<32>, 4>, debugX1: vector<uint<32>, 8>, debugRegs01234: vector<vector<uint<32>, 5>, 8>>
      firrtl.matchingconnect %regFile_io_writeThreadID, %103 : !firrtl.vector<uint<3>, 4>
      %104 = firrtl.subfield %regFile.io[dst] : !firrtl.bundle<readThreadID: vector<uint<3>, 8>, src1: vector<uint<5>, 8>, src2: vector<uint<5>, 8>, src1data: vector<uint<32>, 8>, src2data: vector<uint<32>, 8>, writeThreadID: vector<uint<3>, 4>, dst: vector<uint<5>, 4>, wen: vector<uint<1>, 4>, dstData: vector<uint<32>, 4>, debugX1: vector<uint<32>, 8>, debugRegs01234: vector<vector<uint<32>, 5>, 8>>
      firrtl.matchingconnect %regFile_io_dst, %104 : !firrtl.vector<uint<5>, 4>
      %105 = firrtl.subfield %regFile.io[wen] : !firrtl.bundle<readThreadID: vector<uint<3>, 8>, src1: vector<uint<5>, 8>, src2: vector<uint<5>, 8>, src1data: vector<uint<32>, 8>, src2data: vector<uint<32>, 8>, writeThreadID: vector<uint<3>, 4>, dst: vector<uint<5>, 4>, wen: vector<uint<1>, 4>, dstData: vector<uint<32>, 4>, debugX1: vector<uint<32>, 8>, debugRegs01234: vector<vector<uint<32>, 5>, 8>>
      firrtl.matchingconnect %regFile_io_wen, %105 : !firrtl.vector<uint<1>, 4>
      %106 = firrtl.subfield %regFile.io[dstData] : !firrtl.bundle<readThreadID: vector<uint<3>, 8>, src1: vector<uint<5>, 8>, src2: vector<uint<5>, 8>, src1data: vector<uint<32>, 8>, src2data: vector<uint<32>, 8>, writeThreadID: vector<uint<3>, 4>, dst: vector<uint<5>, 4>, wen: vector<uint<1>, 4>, dstData: vector<uint<32>, 4>, debugX1: vector<uint<32>, 8>, debugRegs01234: vector<vector<uint<32>, 5>, 8>>
      firrtl.matchingconnect %regFile_io_dstData, %106 : !firrtl.vector<uint<32>, 4>
      %107 = firrtl.subfield %regFile.io[debugX1] : !firrtl.bundle<readThreadID: vector<uint<3>, 8>, src1: vector<uint<5>, 8>, src2: vector<uint<5>, 8>, src1data: vector<uint<32>, 8>, src2data: vector<uint<32>, 8>, writeThreadID: vector<uint<3>, 4>, dst: vector<uint<5>, 4>, wen: vector<uint<1>, 4>, dstData: vector<uint<32>, 4>, debugX1: vector<uint<32>, 8>, debugRegs01234: vector<vector<uint<32>, 5>, 8>>
      %108 = firrtl.subfield %regFile.io[debugRegs01234] : !firrtl.bundle<readThreadID: vector<uint<3>, 8>, src1: vector<uint<5>, 8>, src2: vector<uint<5>, 8>, src1data: vector<uint<32>, 8>, src2data: vector<uint<32>, 8>, writeThreadID: vector<uint<3>, 4>, dst: vector<uint<5>, 4>, wen: vector<uint<1>, 4>, dstData: vector<uint<32>, 4>, debugX1: vector<uint<32>, 8>, debugRegs01234: vector<vector<uint<32>, 5>, 8>>
      %109 = firrtl.subindex %102[0] : !firrtl.vector<uint<32>, 8>
      %110 = firrtl.subindex %101[0] : !firrtl.vector<uint<32>, 8>
      ...
      %111 = firrtl.subfield %alu.io[a] : !firrtl.bundle<a: uint<32>, b: uint<32>, opcode: uint<5>, result: uint<32>>
      firrtl.matchingconnect %alu_io_a, %111 : !firrtl.uint<32>
      %112 = firrtl.subfield %alu.io[b] : !firrtl.bundle<a: uint<32>, b: uint<32>, opcode: uint<5>, result: uint<32>>
      firrtl.matchingconnect %alu_io_b, %112 : !firrtl.uint<32>
      %113 = firrtl.subfield %alu.io[opcode] : !firrtl.bundle<a: uint<32>, b: uint<32>, opcode: uint<5>, result: uint<32>>
      firrtl.matchingconnect %alu_io_opcode, %113 : !firrtl.uint<5>
      %114 = firrtl.subfield %alu.io[result] : !firrtl.bundle<a: uint<32>, b: uint<32>, opcode: uint<5>, result: uint<32>>
      ...
      %115 = firrtl.subfield %mulUnit.io[a] : !firrtl.bundle<a: uint<32>, b: uint<32>, signedA: uint<1>, signedB: uint<1>, product: uint<64>, lo: uint<32>, hi: uint<32>>
      firrtl.matchingconnect %mulUnit_io_a, %115 : !firrtl.uint<32>
      %116 = firrtl.subfield %mulUnit.io[b] : !firrtl.bundle<a: uint<32>, b: uint<32>, signedA: uint<1>, signedB: uint<1>, product: uint<64>, lo: uint<32>, hi: uint<32>>
      firrtl.matchingconnect %mulUnit_io_b, %116 : !firrtl.uint<32>
      %117 = firrtl.subfield %mulUnit.io[signedA] : !firrtl.bundle<a: uint<32>, b: uint<32>, signedA: uint<1>, signedB: uint<1>, product: uint<64>, lo: uint<32>, hi: uint<32>>
      firrtl.matchingconnect %mulUnit_io_signedA, %117 : !firrtl.uint<1>
      %118 = firrtl.subfield %mulUnit.io[signedB] : !firrtl.bundle<a: uint<32>, b: uint<32>, signedA: uint<1>, signedB: uint<1>, product: uint<64>, lo: uint<32>, hi: uint<32>>
      firrtl.matchingconnect %mulUnit_io_signedB, %118 : !firrtl.uint<1>
      ...
      %119 = firrtl.subfield %mulUnit.io[hi] : !firrtl.bundle<a: uint<32>, b: uint<32>, signedA: uint<1>, signedB: uint<1>, product: uint<64>, lo: uint<32>, hi: uint<32>>
      ...
      %120 = firrtl.subfield %branchUnit.io[rs1] : !firrtl.bundle<rs1: uint<32>, rs2: uint<32>, pc: uint<32>, imm: sint<32>, branchOp: uint<3>, valid: uint<1>, taken: uint<1>, target: uint<32>, nextPc: uint<32>, misaligned: uint<1>>
      firrtl.matchingconnect %branchUnit_io_rs1, %120 : !firrtl.uint<32>
      %121 = firrtl.subfield %branchUnit.io[rs2] : !firrtl.bundle<rs1: uint<32>, rs2: uint<32>, pc: uint<32>, imm: sint<32>, branchOp: uint<3>, valid: uint<1>, taken: uint<1>, target: uint<32>, nextPc: uint<32>, misaligned: uint<1>>
      firrtl.matchingconnect %branchUnit_io_rs2, %121 : !firrtl.uint<32>
      %122 = firrtl.subfield %branchUnit.io[pc] : !firrtl.bundle<rs1: uint<32>, rs2: uint<32>, pc: uint<32>, imm: sint<32>, branchOp: uint<3>, valid: uint<1>, taken: uint<1>, target: uint<32>, nextPc: uint<32>, misaligned: uint<1>>
      firrtl.matchingconnect %branchUnit_io_pc, %122 : !firrtl.uint<32>
      %123 = firrtl.subfield %branchUnit.io[imm] : !firrtl.bundle<rs1: uint<32>, rs2: uint<32>, pc: uint<32>, imm: sint<32>, branchOp: uint<3>, valid: uint<1>, taken: uint<1>, target: uint<32>, nextPc: uint<32>, misaligned: uint<1>>
      firrtl.matchingconnect %branchUnit_io_imm, %123 : !firrtl.sint<32>
      %124 = firrtl.subfield %branchUnit.io[branchOp] : !firrtl.bundle<rs1: uint<32>, rs2: uint<32>, pc: uint<32>, imm: sint<32>, branchOp: uint<3>, valid: uint<1>, taken: uint<1>, target: uint<32>, nextPc: uint<32>, misaligned: uint<1>>
      firrtl.matchingconnect %branchUnit_io_branchOp, %124 : !firrtl.uint<3>
      %125 = firrtl.subfield %branchUnit.io[valid] : !firrtl.bundle<rs1: uint<32>, rs2: uint<32>, pc: uint<32>, imm: sint<32>, branchOp: uint<3>, valid: uint<1>, taken: uint<1>, target: uint<32>, nextPc: uint<32>, misaligned: uint<1>>
      firrtl.matchingconnect %branchUnit_io_valid, %125 : !firrtl.uint<1>
      %126 = firrtl.subfield %branchUnit.io[taken] : !firrtl.bundle<rs1: uint<32>, rs2: uint<32>, pc: uint<32>, imm: sint<32>, branchOp: uint<3>, valid: uint<1>, taken: uint<1>, target: uint<32>, nextPc: uint<32>, misaligned: uint<1>>
      %127 = firrtl.subfield %branchUnit.io[target] : !firrtl.bundle<rs1: uint<32>, rs2: uint<32>, pc: uint<32>, imm: sint<32>, branchOp: uint<3>, valid: uint<1>, taken: uint<1>, target: uint<32>, nextPc: uint<32>, misaligned: uint<1>>
      %128 = firrtl.subfield %branchUnit.io[nextPc] : !firrtl.bundle<rs1: uint<32>, rs2: uint<32>, pc: uint<32>, imm: sint<32>, branchOp: uint<3>, valid: uint<1>, taken: uint<1>, target: uint<32>, nextPc: uint<32>, misaligned: uint<1>>
      %129 = firrtl.subfield %branchUnit.io[misaligned] : !firrtl.bundle<rs1: uint<32>, rs2: uint<32>, pc: uint<32>, imm: sint<32>, branchOp: uint<3>, valid: uint<1>, taken: uint<1>, target: uint<32>, nextPc: uint<32>, misaligned: uint<1>>
      %unusedBranchNextPc = firrtl.node %128 {annotations = [{class = "firrtl.transforms.DontTouchAnnotation"}]} : !firrtl.uint<32>
      %unusedBranchMisaligned = firrtl.node %129 {annotations = [{class = "firrtl.transforms.DontTouchAnnotation"}]} : !firrtl.uint<1>
      ...
      %130 = firrtl.subfield %loadUnit.io[addr] : !firrtl.bundle<addr: uint<32>, dataIn: uint<32>, funct3: uint<3>, dataOut: uint<32>>
      firrtl.matchingconnect %loadUnit_io_addr, %130 : !firrtl.uint<32>
      %131 = firrtl.subfield %loadUnit.io[dataIn] : !firrtl.bundle<addr: uint<32>, dataIn: uint<32>, funct3: uint<3>, dataOut: uint<32>>
      firrtl.matchingconnect %loadUnit_io_dataIn, %131 : !firrtl.uint<32>
      %132 = firrtl.subfield %loadUnit.io[funct3] : !firrtl.bundle<addr: uint<32>, dataIn: uint<32>, funct3: uint<3>, dataOut: uint<32>>
      firrtl.matchingconnect %loadUnit_io_funct3, %132 : !firrtl.uint<3>
      %133 = firrtl.subfield %loadUnit.io[dataOut] : !firrtl.bundle<addr: uint<32>, dataIn: uint<32>, funct3: uint<3>, dataOut: uint<32>>
      ...
      %134 = firrtl.subfield %storeUnit.io[addr] : !firrtl.bundle<addr: uint<32>, data: uint<32>, storeType: uint<2>, memWrite: uint<32>, mask: uint<4>, misaligned: uint<1>>
      firrtl.matchingconnect %storeUnit_io_addr, %134 : !firrtl.uint<32>
      %135 = firrtl.subfield %storeUnit.io[data] : !firrtl.bundle<addr: uint<32>, data: uint<32>, storeType: uint<2>, memWrite: uint<32>, mask: uint<4>, misaligned: uint<1>>
      firrtl.matchingconnect %storeUnit_io_data, %135 : !firrtl.uint<32>
      %136 = firrtl.subfield %storeUnit.io[storeType] : !firrtl.bundle<addr: uint<32>, data: uint<32>, storeType: uint<2>, memWrite: uint<32>, mask: uint<4>, misaligned: uint<1>>
      firrtl.matchingconnect %storeUnit_io_storeType, %136 : !firrtl.uint<2>
      %137 = firrtl.subfield %storeUnit.io[memWrite] : !firrtl.bundle<addr: uint<32>, data: uint<32>, storeType: uint<2>, memWrite: uint<32>, mask: uint<4>, misaligned: uint<1>>
      %138 = firrtl.subfield %storeUnit.io[mask] : !firrtl.bundle<addr: uint<32>, data: uint<32>, storeType: uint<2>, memWrite: uint<32>, mask: uint<4>, misaligned: uint<1>>
      %139 = firrtl.subfield %storeUnit.io[misaligned] : !firrtl.bundle<addr: uint<32>, data: uint<32>, storeType: uint<2>, memWrite: uint<32>, mask: uint<4>, misaligned: uint<1>>
      ...
      %140 = firrtl.subfield %fetchReg[threadId] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %141 = firrtl.subfield %fetchReg[pc] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %142 = firrtl.subfield %fetchReg[instr] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %143 = firrtl.subfield %fetchReg[instr] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %144 = firrtl.subfield %fetchReg[threadId] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %145 = firrtl.subfield %fetchReg[valid] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %146 = firrtl.subaccess %io_threadEnable_0[%threadCounter] : !firrtl.vector<uint<1>, 8>, !firrtl.uint<3>
      %147 = firrtl.mux(%146, %threadCounter, %140) : (!firrtl.uint<1>, !firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<3>
      %148 = firrtl.subaccess %pcRegs[%threadCounter] : !firrtl.vector<uint<32>, 8>, !firrtl.uint<3>
      %149 = firrtl.mux(%146, %148, %141) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %_fetchReg_instr_T = firrtl.bits %io_instrMem 31 to 0 {name = "_fetchReg_instr_T"} : (!firrtl.uint<128>) -> !firrtl.uint<32>
      %150 = firrtl.mux(%146, %_fetchReg_instr_T, %142) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %_pcRegs_T = firrtl.add %148, %c4_ui3 {name = "_pcRegs_T"} : (!firrtl.uint<32>, !firrtl.uint<3>) -> !firrtl.uint<33>
      %_pcRegs_T_1 = firrtl.bits %_pcRegs_T 31 to 0 {name = "_pcRegs_T_1"} : (!firrtl.uint<33>) -> !firrtl.uint<32>
      %151 = firrtl.orr %threadCounter : (!firrtl.uint<3>) -> !firrtl.uint<1>
      %152 = firrtl.not %151 : (!firrtl.uint<1>) -> !firrtl.uint<1>
      %153 = firrtl.and %146, %152 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %154 = firrtl.mux(%153, %_pcRegs_T_1, %10) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %155 = firrtl.eq %threadCounter, %c1_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %156 = firrtl.and %146, %155 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %157 = firrtl.mux(%156, %_pcRegs_T_1, %11) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %158 = firrtl.eq %threadCounter, %c2_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %159 = firrtl.and %146, %158 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %160 = firrtl.mux(%159, %_pcRegs_T_1, %12) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %161 = firrtl.eq %threadCounter, %c3_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %162 = firrtl.and %146, %161 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %163 = firrtl.mux(%162, %_pcRegs_T_1, %13) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %164 = firrtl.eq %threadCounter, %c4_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %165 = firrtl.and %146, %164 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %166 = firrtl.mux(%165, %_pcRegs_T_1, %14) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %167 = firrtl.eq %threadCounter, %c5_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %168 = firrtl.and %146, %167 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %169 = firrtl.mux(%168, %_pcRegs_T_1, %15) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %170 = firrtl.eq %threadCounter, %c6_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %171 = firrtl.and %146, %170 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %172 = firrtl.mux(%171, %_pcRegs_T_1, %16) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %173 = firrtl.andr %threadCounter : (!firrtl.uint<3>) -> !firrtl.uint<1>
      %174 = firrtl.and %146, %173 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %175 = firrtl.mux(%174, %_pcRegs_T_1, %17) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      ...
      %176 = firrtl.subfield %decodeReg[fetchSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %177 = firrtl.subfield %176[threadId] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %178 = firrtl.subfield %176[pc] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %179 = firrtl.subfield %176[instr] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %180 = firrtl.subfield %decodeReg[decodeSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %181 = firrtl.subfield %180[isALU] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %182 = firrtl.subfield %180[isLoad] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %183 = firrtl.subfield %180[isStore] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %184 = firrtl.subfield %180[isBranch] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %185 = firrtl.subfield %180[isJAL] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %186 = firrtl.subfield %180[isJALR] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %187 = firrtl.subfield %180[isLUI] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %188 = firrtl.subfield %180[isAUIPC] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %189 = firrtl.subfield %180[isSystem] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %190 = firrtl.subfield %180[isFence] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %191 = firrtl.subfield %180[usesImm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %192 = firrtl.subfield %180[rs1] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %193 = firrtl.subfield %180[rs2] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %194 = firrtl.subfield %180[rd] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %195 = firrtl.subfield %180[aluOp] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %196 = firrtl.subfield %180[imm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %197 = firrtl.subfield %decodeReg[fetchSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %198 = firrtl.subfield %197[threadId] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %199 = firrtl.subfield %197[valid] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %200 = firrtl.subfield %fetchReg[valid] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %201 = firrtl.subfield %fetchReg[threadId] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %202 = firrtl.mux(%145, %201, %177) : (!firrtl.uint<1>, !firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<3>
      %203 = firrtl.subfield %fetchReg[pc] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %204 = firrtl.mux(%145, %203, %178) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %205 = firrtl.subfield %fetchReg[instr] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %206 = firrtl.mux(%145, %205, %179) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      ...
      %decodeReg_decodeSignals_opcode = firrtl.bits %143 6 to 0 {name = "decodeReg_decodeSignals_opcode"} : (!firrtl.uint<32>) -> !firrtl.uint<7>
      %decodeReg_decodeSignals_funct3 = firrtl.bits %143 14 to 12 {name = "decodeReg_decodeSignals_funct3"} : (!firrtl.uint<32>) -> !firrtl.uint<3>
      %decodeReg_decodeSignals_funct7 = firrtl.bits %143 31 to 25 {name = "decodeReg_decodeSignals_funct7"} : (!firrtl.uint<32>) -> !firrtl.uint<7>
      %_decodeReg_decodeSignals_dec_rs1_T = firrtl.bits %143 19 to 15 {name = "_decodeReg_decodeSignals_dec_rs1_T"} : (!firrtl.uint<32>) -> !firrtl.uint<5>
      %_decodeReg_decodeSignals_dec_rs2_T = firrtl.bits %143 24 to 20 {name = "_decodeReg_decodeSignals_dec_rs2_T"} : (!firrtl.uint<32>) -> !firrtl.uint<5>
      %_decodeReg_decodeSignals_storeImm_T_1 = firrtl.bits %143 11 to 7 {name = "_decodeReg_decodeSignals_storeImm_T_1"} : (!firrtl.uint<32>) -> !firrtl.uint<5>
      ...
      %207 = firrtl.orr %decodeReg_decodeSignals_funct3 : (!firrtl.uint<3>) -> !firrtl.uint<1>
      %_decodeReg_decodeSignals_T_1 = firrtl.not %207 {name = "_decodeReg_decodeSignals_T_1"} : (!firrtl.uint<1>) -> !firrtl.uint<1>
      ...
      %208 = firrtl.mux(%_decodeReg_decodeSignals_T_2, %c1_ui5, %c0_ui5) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      ...
      %209 = firrtl.mux(%_decodeReg_decodeSignals_T_8, %c11_ui5, %c10_ui5) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      ...
      %210 = firrtl.mux(%_decodeReg_decodeSignals_T_10, %c14_ui5, %c0_ui5) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %211 = firrtl.mux(%_decodeReg_decodeSignals_T_9, %c12_ui5, %210) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %212 = firrtl.mux(%_decodeReg_decodeSignals_T_7, %209, %211) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %213 = firrtl.mux(%_decodeReg_decodeSignals_T_6, %c8_ui5, %212) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %214 = firrtl.mux(%_decodeReg_decodeSignals_T_5, %c6_ui5, %213) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %215 = firrtl.mux(%_decodeReg_decodeSignals_T_4, %c4_ui5, %214) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %216 = firrtl.mux(%_decodeReg_decodeSignals_T_3, %c2_ui5, %215) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %217 = firrtl.mux(%_decodeReg_decodeSignals_T_1, %208, %216) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      ...
      %218 = firrtl.or %_decodeReg_decodeSignals_T, %_decodeReg_decodeSignals_T_11 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %_decodeReg_decodeSignals_immI_T = firrtl.bits %143 31 to 20 {name = "_decodeReg_decodeSignals_immI_T"} : (!firrtl.uint<32>) -> !firrtl.uint<12>
      %decodeReg_decodeSignals_immI_sign = firrtl.bits %143 31 to 31 {name = "decodeReg_decodeSignals_immI_sign"} : (!firrtl.uint<32>) -> !firrtl.uint<1>
      ...
      %219 = firrtl.orr %decodeReg_decodeSignals_funct3 : (!firrtl.uint<3>) -> !firrtl.uint<1>
      %_decodeReg_decodeSignals_T_12 = firrtl.not %219 {name = "_decodeReg_decodeSignals_T_12"} : (!firrtl.uint<1>) -> !firrtl.uint<1>
      ...
      %_decodeReg_decodeSignals_T_21 = firrtl.bits %143 30 to 30 {name = "_decodeReg_decodeSignals_T_21"} : (!firrtl.uint<32>) -> !firrtl.uint<1>
      %220 = firrtl.mux(%_decodeReg_decodeSignals_T_21, %c11_ui5, %c10_ui5) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %221 = firrtl.mux(%_decodeReg_decodeSignals_T_19, %220, %c0_ui5) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %222 = firrtl.mux(%_decodeReg_decodeSignals_T_18, %c2_ui5, %221) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %223 = firrtl.mux(%_decodeReg_decodeSignals_T_17, %c14_ui5, %222) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %224 = firrtl.mux(%_decodeReg_decodeSignals_T_16, %c12_ui5, %223) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %225 = firrtl.mux(%_decodeReg_decodeSignals_T_15, %c8_ui5, %224) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %226 = firrtl.mux(%_decodeReg_decodeSignals_T_14, %c6_ui5, %225) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %227 = firrtl.mux(%_decodeReg_decodeSignals_T_13, %c4_ui5, %226) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %228 = firrtl.mux(%_decodeReg_decodeSignals_T_12, %c0_ui5, %227) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %229 = firrtl.mux(%_decodeReg_decodeSignals_T_11, %228, %c0_ui5) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %230 = firrtl.mux(%_decodeReg_decodeSignals_T, %217, %229) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      ...
      %231 = firrtl.or %_decodeReg_decodeSignals_T, %_decodeReg_decodeSignals_T_11 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %232 = firrtl.mux(%231, %c0_ui1, %_decodeReg_decodeSignals_T_22) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %_decodeReg_decodeSignals_dec_imm_T = firrtl.bits %143 31 to 20 {name = "_decodeReg_decodeSignals_dec_imm_T"} : (!firrtl.uint<32>) -> !firrtl.uint<12>
      %decodeReg_decodeSignals_dec_imm_sign = firrtl.bits %143 31 to 31 {name = "decodeReg_decodeSignals_dec_imm_sign"} : (!firrtl.uint<32>) -> !firrtl.uint<1>
      ...
      %233 = firrtl.or %_decodeReg_decodeSignals_T_11, %_decodeReg_decodeSignals_T_22 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %234 = firrtl.or %_decodeReg_decodeSignals_T, %233 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %235 = firrtl.mux(%234, %c0_ui1, %_decodeReg_decodeSignals_T_23) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %decodeReg_decodeSignals_dec_imm_sign_1 = firrtl.bits %143 31 to 31 {name = "decodeReg_decodeSignals_dec_imm_sign_1"} : (!firrtl.uint<32>) -> !firrtl.uint<1>
      ...
      %236 = firrtl.or %_decodeReg_decodeSignals_T_22, %_decodeReg_decodeSignals_T_23 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %237 = firrtl.or %_decodeReg_decodeSignals_T_11, %236 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %238 = firrtl.or %_decodeReg_decodeSignals_T, %237 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %239 = firrtl.mux(%238, %c0_ui1, %_decodeReg_decodeSignals_T_24) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %decodeReg_decodeSignals_dec_imm_sign_2 = firrtl.bits %143 31 to 31 {name = "decodeReg_decodeSignals_dec_imm_sign_2"} : (!firrtl.uint<32>) -> !firrtl.uint<1>
      %_decodeReg_decodeSignals_branchImm_T_1 = firrtl.bits %143 7 to 7 {name = "_decodeReg_decodeSignals_branchImm_T_1"} : (!firrtl.uint<32>) -> !firrtl.uint<1>
      %_decodeReg_decodeSignals_branchImm_T_2 = firrtl.bits %143 30 to 25 {name = "_decodeReg_decodeSignals_branchImm_T_2"} : (!firrtl.uint<32>) -> !firrtl.uint<6>
      %_decodeReg_decodeSignals_branchImm_T_3 = firrtl.bits %143 11 to 8 {name = "_decodeReg_decodeSignals_branchImm_T_3"} : (!firrtl.uint<32>) -> !firrtl.uint<4>
      ...
      %240 = firrtl.or %_decodeReg_decodeSignals_T_23, %_decodeReg_decodeSignals_T_24 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %241 = firrtl.or %_decodeReg_decodeSignals_T_22, %240 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      ...
      %244 = firrtl.mux(%243, %c0_ui1, %_decodeReg_decodeSignals_T_25) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %decodeReg_decodeSignals_dec_imm_sign_3 = firrtl.bits %143 31 to 31 {name = "decodeReg_decodeSignals_dec_imm_sign_3"} : (!firrtl.uint<32>) -> !firrtl.uint<1>
      %_decodeReg_decodeSignals_jumpImm_T_1 = firrtl.bits %143 19 to 12 {name = "_decodeReg_decodeSignals_jumpImm_T_1"} : (!firrtl.uint<32>) -> !firrtl.uint<8>
      %_decodeReg_decodeSignals_jumpImm_T_2 = firrtl.bits %143 20 to 20 {name = "_decodeReg_decodeSignals_jumpImm_T_2"} : (!firrtl.uint<32>) -> !firrtl.uint<1>
      %_decodeReg_decodeSignals_jumpImm_T_3 = firrtl.bits %143 30 to 21 {name = "_decodeReg_decodeSignals_jumpImm_T_3"} : (!firrtl.uint<32>) -> !firrtl.uint<10>
      ...
      %245 = firrtl.or %_decodeReg_decodeSignals_T_24, %_decodeReg_decodeSignals_T_25 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %246 = firrtl.or %_decodeReg_decodeSignals_T_23, %245 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      ...
      %250 = firrtl.mux(%249, %c0_ui1, %_decodeReg_decodeSignals_T_26) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %_decodeReg_decodeSignals_dec_imm_T_10 = firrtl.bits %143 31 to 20 {name = "_decodeReg_decodeSignals_dec_imm_T_10"} : (!firrtl.uint<32>) -> !firrtl.uint<12>
      %decodeReg_decodeSignals_dec_imm_sign_4 = firrtl.bits %143 31 to 31 {name = "decodeReg_decodeSignals_dec_imm_sign_4"} : (!firrtl.uint<32>) -> !firrtl.uint<1>
      ...
      %251 = firrtl.or %_decodeReg_decodeSignals_T_25, %_decodeReg_decodeSignals_T_26 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %252 = firrtl.or %_decodeReg_decodeSignals_T_24, %251 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %253 = firrtl.or %_decodeReg_decodeSignals_T_23, %252 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %254 = firrtl.or %_decodeReg_decodeSignals_T_22, %253 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %255 = firrtl.or %_decodeReg_decodeSignals_T_11, %254 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %256 = firrtl.or %_decodeReg_decodeSignals_T, %255 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %257 = firrtl.mux(%256, %c0_ui1, %_decodeReg_decodeSignals_T_27) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %_decodeReg_decodeSignals_dec_imm_T_13 = firrtl.bits %143 31 to 12 {name = "_decodeReg_decodeSignals_dec_imm_T_13"} : (!firrtl.uint<32>) -> !firrtl.uint<20>
      ...
      %258 = firrtl.or %_decodeReg_decodeSignals_T_26, %_decodeReg_decodeSignals_T_27 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %259 = firrtl.or %_decodeReg_decodeSignals_T_25, %258 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      ...
      %265 = firrtl.mux(%264, %c0_ui1, %_decodeReg_decodeSignals_T_28) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %266 = firrtl.or %_decodeReg_decodeSignals_T_27, %_decodeReg_decodeSignals_T_28 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %267 = firrtl.or %_decodeReg_decodeSignals_T_26, %266 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %268 = firrtl.or %_decodeReg_decodeSignals_T_24, %_decodeReg_decodeSignals_T_25 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %269 = firrtl.mux(%268, %c0_ui1, %267) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %270 = firrtl.or %_decodeReg_decodeSignals_T_22, %_decodeReg_decodeSignals_T_23 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %271 = firrtl.or %_decodeReg_decodeSignals_T_11, %270 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %272 = firrtl.mux(%271, %c1_ui1, %269) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %273 = firrtl.mux(%_decodeReg_decodeSignals_T, %c0_ui1, %272) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %_decodeReg_decodeSignals_dec_imm_T_16 = firrtl.bits %143 31 to 12 {name = "_decodeReg_decodeSignals_dec_imm_T_16"} : (!firrtl.uint<32>) -> !firrtl.uint<20>
      ...
      %274 = firrtl.mux(%_decodeReg_decodeSignals_T_28, %_decodeReg_decodeSignals_dec_imm_T_18, %c0_ui32) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %275 = firrtl.mux(%_decodeReg_decodeSignals_T_27, %_decodeReg_decodeSignals_dec_imm_T_15, %274) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %276 = firrtl.mux(%_decodeReg_decodeSignals_T_26, %_decodeReg_decodeSignals_dec_imm_T_12, %275) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %277 = firrtl.mux(%_decodeReg_decodeSignals_T_25, %_decodeReg_decodeSignals_dec_imm_T_9, %276) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %278 = firrtl.mux(%_decodeReg_decodeSignals_T_24, %_decodeReg_decodeSignals_dec_imm_T_6, %277) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %279 = firrtl.mux(%_decodeReg_decodeSignals_T_23, %_decodeReg_decodeSignals_dec_imm_T_4, %278) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %280 = firrtl.mux(%_decodeReg_decodeSignals_T_22, %_decodeReg_decodeSignals_dec_imm_T_2, %279) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %281 = firrtl.mux(%_decodeReg_decodeSignals_T_11, %decodeReg_decodeSignals_immI, %280) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %282 = firrtl.mux(%_decodeReg_decodeSignals_T, %c0_ui32, %281) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      ...
      %283 = firrtl.or %_decodeReg_decodeSignals_T_27, %_decodeReg_decodeSignals_T_28 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %284 = firrtl.or %_decodeReg_decodeSignals_T_26, %283 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %285 = firrtl.or %_decodeReg_decodeSignals_T_25, %284 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %286 = firrtl.or %_decodeReg_decodeSignals_T_24, %285 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %287 = firrtl.or %_decodeReg_decodeSignals_T_23, %286 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %288 = firrtl.or %_decodeReg_decodeSignals_T_22, %287 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %289 = firrtl.or %_decodeReg_decodeSignals_T_11, %288 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %290 = firrtl.or %_decodeReg_decodeSignals_T, %289 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %291 = firrtl.mux(%290, %c0_ui1, %_decodeReg_decodeSignals_T_29) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      ...
      %292 = firrtl.or %_decodeReg_decodeSignals_T_28, %_decodeReg_decodeSignals_T_29 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %293 = firrtl.or %_decodeReg_decodeSignals_T_27, %292 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %294 = firrtl.or %_decodeReg_decodeSignals_T_26, %293 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %295 = firrtl.or %_decodeReg_decodeSignals_T_25, %294 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %296 = firrtl.or %_decodeReg_decodeSignals_T_24, %295 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %297 = firrtl.or %_decodeReg_decodeSignals_T_23, %296 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %298 = firrtl.or %_decodeReg_decodeSignals_T_22, %297 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %299 = firrtl.or %_decodeReg_decodeSignals_T_11, %298 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %300 = firrtl.or %_decodeReg_decodeSignals_T, %299 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %301 = firrtl.mux(%300, %c0_ui1, %_decodeReg_decodeSignals_T_30) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %302 = firrtl.bundlecreate %218, %232, %235, %239, %244, %250, %257, %265, %291, %301, %273, %_decodeReg_decodeSignals_dec_rs1_T, %_decodeReg_decodeSignals_dec_rs2_T, %_decodeReg_decodeSignals_storeImm_T_1, %230, %282 : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<32>) -> !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      firrtl.matchingconnect %decodeReg_decodeSignals_dec, %302 : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %303 = firrtl.subfield %decodeReg_decodeSignals_dec[isALU] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %304 = firrtl.mux(%145, %303, %181) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %305 = firrtl.subfield %decodeReg_decodeSignals_dec[isLoad] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %306 = firrtl.mux(%145, %305, %182) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %307 = firrtl.subfield %decodeReg_decodeSignals_dec[isStore] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %308 = firrtl.mux(%145, %307, %183) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %309 = firrtl.subfield %decodeReg_decodeSignals_dec[isBranch] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %310 = firrtl.mux(%145, %309, %184) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %311 = firrtl.subfield %decodeReg_decodeSignals_dec[isJAL] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %312 = firrtl.mux(%145, %311, %185) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %313 = firrtl.subfield %decodeReg_decodeSignals_dec[isJALR] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %314 = firrtl.mux(%145, %313, %186) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %315 = firrtl.subfield %decodeReg_decodeSignals_dec[isLUI] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %316 = firrtl.mux(%145, %315, %187) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %317 = firrtl.subfield %decodeReg_decodeSignals_dec[isAUIPC] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %318 = firrtl.mux(%145, %317, %188) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %319 = firrtl.subfield %decodeReg_decodeSignals_dec[isSystem] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %320 = firrtl.mux(%145, %319, %189) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %321 = firrtl.subfield %decodeReg_decodeSignals_dec[isFence] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %322 = firrtl.mux(%145, %321, %190) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %323 = firrtl.subfield %decodeReg_decodeSignals_dec[usesImm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %324 = firrtl.mux(%145, %323, %191) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %325 = firrtl.subfield %decodeReg_decodeSignals_dec[rs1] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %326 = firrtl.mux(%145, %325, %192) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %327 = firrtl.subfield %decodeReg_decodeSignals_dec[rs2] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %328 = firrtl.mux(%145, %327, %193) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %329 = firrtl.subfield %decodeReg_decodeSignals_dec[rd] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %330 = firrtl.mux(%145, %329, %194) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %331 = firrtl.subfield %decodeReg_decodeSignals_dec[aluOp] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %332 = firrtl.mux(%145, %331, %195) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %333 = firrtl.subfield %decodeReg_decodeSignals_dec[imm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %334 = firrtl.mux(%145, %333, %196) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %335 = firrtl.mux(%145, %200, %c0_ui1) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      ...
      %336 = firrtl.subfield %dispatchReg[decodePipelineSignals] : !firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>
      %337 = firrtl.subfield %336[fetchSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %338 = firrtl.subfield %337[threadId] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %339 = firrtl.subfield %337[pc] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %340 = firrtl.subfield %337[instr] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %341 = firrtl.subfield %336[decodeSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %342 = firrtl.subfield %341[isALU] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %343 = firrtl.subfield %341[isLoad] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %344 = firrtl.subfield %341[isStore] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %345 = firrtl.subfield %341[isBranch] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %346 = firrtl.subfield %341[isJAL] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %347 = firrtl.subfield %341[isJALR] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %348 = firrtl.subfield %341[isLUI] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %349 = firrtl.subfield %341[isAUIPC] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %350 = firrtl.subfield %341[isSystem] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %351 = firrtl.subfield %341[isFence] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %352 = firrtl.subfield %341[usesImm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %353 = firrtl.subfield %341[rs1] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %354 = firrtl.subfield %341[rs2] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %355 = firrtl.subfield %341[rd] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %356 = firrtl.subfield %341[aluOp] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %357 = firrtl.subfield %341[imm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %358 = firrtl.subfield %dispatchReg[decodePipelineSignals] : !firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>
      %359 = firrtl.subfield %358[decodeSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %360 = firrtl.subfield %359[rs2] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %361 = firrtl.subfield %359[rs1] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %362 = firrtl.subfield %358[fetchSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %363 = firrtl.subfield %362[threadId] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %364 = firrtl.subfield %362[valid] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %365 = firrtl.subfield %decodeReg[fetchSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %366 = firrtl.subfield %365[valid] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %367 = firrtl.subfield %365[threadId] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %368 = firrtl.mux(%199, %367, %338) : (!firrtl.uint<1>, !firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<3>
      %369 = firrtl.subfield %365[pc] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %370 = firrtl.mux(%199, %369, %339) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %371 = firrtl.subfield %365[instr] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %372 = firrtl.mux(%199, %371, %340) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %373 = firrtl.subfield %decodeReg[decodeSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %374 = firrtl.subfield %373[isALU] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %375 = firrtl.mux(%199, %374, %342) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %376 = firrtl.subfield %373[isLoad] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %377 = firrtl.mux(%199, %376, %343) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %378 = firrtl.subfield %373[isStore] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %379 = firrtl.mux(%199, %378, %344) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %380 = firrtl.subfield %373[isBranch] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %381 = firrtl.mux(%199, %380, %345) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %382 = firrtl.subfield %373[isJAL] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %383 = firrtl.mux(%199, %382, %346) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %384 = firrtl.subfield %373[isJALR] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %385 = firrtl.mux(%199, %384, %347) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %386 = firrtl.subfield %373[isLUI] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %387 = firrtl.mux(%199, %386, %348) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %388 = firrtl.subfield %373[isAUIPC] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %389 = firrtl.mux(%199, %388, %349) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %390 = firrtl.subfield %373[isSystem] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %391 = firrtl.mux(%199, %390, %350) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %392 = firrtl.subfield %373[isFence] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %393 = firrtl.mux(%199, %392, %351) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %394 = firrtl.subfield %373[usesImm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %395 = firrtl.mux(%199, %394, %352) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %396 = firrtl.subfield %373[rs1] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %397 = firrtl.mux(%199, %396, %353) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %398 = firrtl.subfield %373[rs2] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %399 = firrtl.mux(%199, %398, %354) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %400 = firrtl.subfield %373[rd] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %401 = firrtl.mux(%199, %400, %355) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %402 = firrtl.subfield %373[aluOp] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %403 = firrtl.mux(%199, %402, %356) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %404 = firrtl.subfield %373[imm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %405 = firrtl.mux(%199, %404, %357) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %406 = firrtl.mux(%199, %366, %c0_ui1) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      ...
      %407 = firrtl.subfield %regReadReg[dispatchSignals] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %408 = firrtl.subfield %407[decodePipelineSignals] : !firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>
      %409 = firrtl.subfield %408[fetchSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %410 = firrtl.subfield %409[threadId] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %411 = firrtl.subfield %409[pc] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %412 = firrtl.subfield %409[instr] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %413 = firrtl.subfield %408[decodeSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %414 = firrtl.subfield %413[isALU] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %415 = firrtl.subfield %413[isLoad] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %416 = firrtl.subfield %413[isStore] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %417 = firrtl.subfield %413[isBranch] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %418 = firrtl.subfield %413[isJAL] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %419 = firrtl.subfield %413[isJALR] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %420 = firrtl.subfield %413[isLUI] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %421 = firrtl.subfield %413[isAUIPC] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %422 = firrtl.subfield %413[isSystem] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %423 = firrtl.subfield %413[isFence] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %424 = firrtl.subfield %413[usesImm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %425 = firrtl.subfield %413[rs1] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %426 = firrtl.subfield %413[rs2] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %427 = firrtl.subfield %413[rd] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %428 = firrtl.subfield %413[aluOp] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %429 = firrtl.subfield %413[imm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %430 = firrtl.subfield %regReadReg[rs1Data] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %431 = firrtl.subfield %regReadReg[rs2Data] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %432 = firrtl.subfield %regReadReg[rs2Data] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %433 = firrtl.subfield %regReadReg[rs1Data] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %434 = firrtl.subfield %regReadReg[dispatchSignals] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %435 = firrtl.subfield %434[decodePipelineSignals] : !firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>
      %436 = firrtl.subfield %435[decodeSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %437 = firrtl.subfield %436[isStore] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %438 = firrtl.subfield %436[isLoad] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %439 = firrtl.subfield %436[isBranch] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %440 = firrtl.subfield %436[isJALR] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %441 = firrtl.subfield %436[isJAL] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %442 = firrtl.subfield %436[aluOp] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %443 = firrtl.subfield %436[imm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %444 = firrtl.subfield %436[isAUIPC] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %445 = firrtl.subfield %436[isLUI] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %446 = firrtl.subfield %436[isALU] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %447 = firrtl.subfield %435[fetchSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %448 = firrtl.subfield %447[threadId] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %449 = firrtl.subfield %447[pc] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %450 = firrtl.subfield %447[instr] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %451 = firrtl.subfield %447[valid] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %452 = firrtl.subfield %dispatchReg[decodePipelineSignals] : !firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>
      %453 = firrtl.subfield %452[fetchSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %454 = firrtl.subfield %453[valid] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %455 = firrtl.subfield %453[threadId] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %456 = firrtl.mux(%364, %455, %410) : (!firrtl.uint<1>, !firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<3>
      %457 = firrtl.subfield %453[pc] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %458 = firrtl.mux(%364, %457, %411) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %459 = firrtl.subfield %453[instr] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %460 = firrtl.mux(%364, %459, %412) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %461 = firrtl.subfield %452[decodeSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %462 = firrtl.subfield %461[isALU] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %463 = firrtl.mux(%364, %462, %414) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %464 = firrtl.subfield %461[isLoad] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %465 = firrtl.mux(%364, %464, %415) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %466 = firrtl.subfield %461[isStore] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %467 = firrtl.mux(%364, %466, %416) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %468 = firrtl.subfield %461[isBranch] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %469 = firrtl.mux(%364, %468, %417) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %470 = firrtl.subfield %461[isJAL] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %471 = firrtl.mux(%364, %470, %418) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %472 = firrtl.subfield %461[isJALR] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %473 = firrtl.mux(%364, %472, %419) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %474 = firrtl.subfield %461[isLUI] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %475 = firrtl.mux(%364, %474, %420) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %476 = firrtl.subfield %461[isAUIPC] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %477 = firrtl.mux(%364, %476, %421) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %478 = firrtl.subfield %461[isSystem] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %479 = firrtl.mux(%364, %478, %422) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %480 = firrtl.subfield %461[isFence] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %481 = firrtl.mux(%364, %480, %423) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %482 = firrtl.subfield %461[usesImm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %483 = firrtl.mux(%364, %482, %424) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %484 = firrtl.subfield %461[rs1] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %485 = firrtl.mux(%364, %484, %425) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %486 = firrtl.subfield %461[rs2] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %487 = firrtl.mux(%364, %486, %426) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %488 = firrtl.subfield %461[rd] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %489 = firrtl.mux(%364, %488, %427) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %490 = firrtl.subfield %461[aluOp] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %491 = firrtl.mux(%364, %490, %428) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %492 = firrtl.subfield %461[imm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %493 = firrtl.mux(%364, %492, %429) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %494 = firrtl.mux(%364, %363, %c0_ui3) : (!firrtl.uint<1>, !firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<3>
      %495 = firrtl.mux(%364, %361, %c0_ui5) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %496 = firrtl.mux(%364, %360, %c0_ui5) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %497 = firrtl.mux(%364, %110, %430) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %498 = firrtl.mux(%364, %109, %431) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %499 = firrtl.mux(%364, %454, %c0_ui1) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      ...
      %500 = firrtl.subfield %exec1Reg[regReadSignals] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %501 = firrtl.subfield %500[dispatchSignals] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %502 = firrtl.subfield %501[decodePipelineSignals] : !firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>
      %503 = firrtl.subfield %502[fetchSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %504 = firrtl.subfield %503[threadId] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %505 = firrtl.subfield %503[pc] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %506 = firrtl.subfield %503[instr] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %507 = firrtl.subfield %502[decodeSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %508 = firrtl.subfield %507[isALU] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %509 = firrtl.subfield %507[isLoad] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %510 = firrtl.subfield %507[isStore] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %511 = firrtl.subfield %507[isBranch] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %512 = firrtl.subfield %507[isJAL] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %513 = firrtl.subfield %507[isJALR] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %514 = firrtl.subfield %507[isLUI] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %515 = firrtl.subfield %507[isAUIPC] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %516 = firrtl.subfield %507[isSystem] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %517 = firrtl.subfield %507[isFence] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %518 = firrtl.subfield %507[usesImm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %519 = firrtl.subfield %507[rs1] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %520 = firrtl.subfield %507[rs2] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %521 = firrtl.subfield %507[rd] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %522 = firrtl.subfield %507[aluOp] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %523 = firrtl.subfield %507[imm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %524 = firrtl.subfield %500[rs1Data] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %525 = firrtl.subfield %500[rs2Data] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %526 = firrtl.subfield %exec1Reg[result] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %527 = firrtl.subfield %exec1Reg[doRegFileWrite] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %528 = firrtl.subfield %exec1Reg[ctrlTaken] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %529 = firrtl.subfield %exec1Reg[ctrlTarget] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %530 = firrtl.subfield %exec1Reg[ctrlTarget] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %531 = firrtl.subfield %exec1Reg[ctrlTaken] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %532 = firrtl.subfield %exec1Reg[regReadSignals] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %533 = firrtl.subfield %532[dispatchSignals] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %534 = firrtl.subfield %533[decodePipelineSignals] : !firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>
      %535 = firrtl.subfield %534[fetchSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %536 = firrtl.subfield %535[threadId] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %537 = firrtl.subfield %535[valid] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %538 = firrtl.subfield %regReadReg[dispatchSignals] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %539 = firrtl.subfield %538[decodePipelineSignals] : !firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>
      %540 = firrtl.subfield %539[fetchSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %541 = firrtl.subfield %540[valid] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %542 = firrtl.subfield %540[threadId] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %543 = firrtl.mux(%451, %542, %504) : (!firrtl.uint<1>, !firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<3>
      %544 = firrtl.subfield %540[pc] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %545 = firrtl.mux(%451, %544, %505) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %546 = firrtl.subfield %540[instr] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %547 = firrtl.mux(%451, %546, %506) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %548 = firrtl.subfield %539[decodeSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %549 = firrtl.subfield %548[isALU] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %550 = firrtl.mux(%451, %549, %508) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %551 = firrtl.subfield %548[isLoad] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %552 = firrtl.mux(%451, %551, %509) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %553 = firrtl.subfield %548[isStore] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %554 = firrtl.mux(%451, %553, %510) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %555 = firrtl.subfield %548[isBranch] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %556 = firrtl.mux(%451, %555, %511) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %557 = firrtl.subfield %548[isJAL] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %558 = firrtl.mux(%451, %557, %512) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %559 = firrtl.subfield %548[isJALR] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %560 = firrtl.mux(%451, %559, %513) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %561 = firrtl.subfield %548[isLUI] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %562 = firrtl.mux(%451, %561, %514) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %563 = firrtl.subfield %548[isAUIPC] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %564 = firrtl.mux(%451, %563, %515) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %565 = firrtl.subfield %548[isSystem] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %566 = firrtl.mux(%451, %565, %516) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %567 = firrtl.subfield %548[isFence] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %568 = firrtl.mux(%451, %567, %517) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %569 = firrtl.subfield %548[usesImm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %570 = firrtl.mux(%451, %569, %518) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %571 = firrtl.subfield %548[rs1] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %572 = firrtl.mux(%451, %571, %519) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %573 = firrtl.subfield %548[rs2] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %574 = firrtl.mux(%451, %573, %520) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %575 = firrtl.subfield %548[rd] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %576 = firrtl.mux(%451, %575, %521) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %577 = firrtl.subfield %548[aluOp] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %578 = firrtl.mux(%451, %577, %522) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %579 = firrtl.subfield %548[imm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %580 = firrtl.mux(%451, %579, %523) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %581 = firrtl.subfield %regReadReg[rs1Data] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %582 = firrtl.mux(%451, %581, %524) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %583 = firrtl.subfield %regReadReg[rs2Data] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %584 = firrtl.mux(%451, %583, %525) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %opcode = firrtl.bits %450 6 to 0 {name = "opcode"} : (!firrtl.uint<32>) -> !firrtl.uint<7>
      %_isMExt_T_1 = firrtl.eq %opcode, %c51_ui7 {name = "_isMExt_T_1"} : (!firrtl.uint<7>, !firrtl.uint<7>) -> !firrtl.uint<1>
      %_isMExt_T_2 = firrtl.bits %450 31 to 25 {name = "_isMExt_T_2"} : (!firrtl.uint<32>) -> !firrtl.uint<7>
      ...
      %funct3 = firrtl.bits %450 14 to 12 {name = "funct3"} : (!firrtl.uint<32>) -> !firrtl.uint<3>
      ...
      %585 = firrtl.mux(%451, %433, %c0_ui32) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %586 = firrtl.mux(%451, %432, %c0_ui32) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %_mulUnit_io_signedB_T = firrtl.neq %funct3, %c3_ui2 {name = "_mulUnit_io_signedB_T"} : (!firrtl.uint<3>, !firrtl.uint<2>) -> !firrtl.uint<1>
      %587 = firrtl.mux(%451, %_mulUnit_io_signedB_T, %c0_ui1) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      ...
      %588 = firrtl.mux(%451, %_mulUnit_io_signedB_T_2, %c0_ui1) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %589 = firrtl.bundlecreate %585, %586, %587, %588, %mulUnit_io_product, %mulUnit_io_lo, %mulUnit_io_hi : (!firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<64>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.bundle<a: uint<32>, b: uint<32>, signedA: uint<1>, signedB: uint<1>, product: uint<64>, lo: uint<32>, hi: uint<32>>
      firrtl.matchingconnect %mulUnit.io, %589 : !firrtl.bundle<a: uint<32>, b: uint<32>, signedA: uint<1>, signedB: uint<1>, product: uint<64>, lo: uint<32>, hi: uint<32>>
      %590 = firrtl.or %446, %445 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %591 = firrtl.or %590, %444 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %_useImm_T = firrtl.eq %opcode, %c19_ui7 {name = "_useImm_T"} : (!firrtl.uint<7>, !firrtl.uint<7>) -> !firrtl.uint<1>
      %_useImm_T_1 = firrtl.or %_useImm_T, %445 {name = "_useImm_T_1"} : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %useImm = firrtl.or %_useImm_T_1, %444 {name = "useImm"} : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %_opA_T = firrtl.mux(%445, %c0_ui32, %433) {name = "_opA_T"} : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %opA = firrtl.mux(%444, %449, %_opA_T) {name = "opA"} : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %opB = firrtl.mux(%useImm, %443, %432) {name = "opB"} : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %592 = firrtl.and %451, %591 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %593 = firrtl.mux(%592, %opA, %c0_ui32) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %594 = firrtl.and %451, %591 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %595 = firrtl.mux(%594, %opB, %c0_ui32) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %596 = firrtl.and %451, %591 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %597 = firrtl.mux(%596, %442, %c0_ui5) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %598 = firrtl.bundlecreate %593, %595, %597, %alu_io_result : (!firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<5>, !firrtl.uint<32>) -> !firrtl.bundle<a: uint<32>, b: uint<32>, opcode: uint<5>, result: uint<32>>
      firrtl.matchingconnect %alu.io, %598 : !firrtl.bundle<a: uint<32>, b: uint<32>, opcode: uint<5>, result: uint<32>>
      %_result_T = firrtl.add %449, %443 {name = "_result_T"} : (!firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<33>
      %_result_T_1 = firrtl.bits %_result_T 31 to 0 {name = "_result_T_1"} : (!firrtl.uint<33>) -> !firrtl.uint<32>
      %_result_T_2 = firrtl.mux(%445, %443, %114) {name = "_result_T_2"} : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %result = firrtl.mux(%444, %_result_T_1, %_result_T_2) {name = "result"} : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %_exec1Reg_result_T = firrtl.add %449, %c4_ui3 {name = "_exec1Reg_result_T"} : (!firrtl.uint<32>, !firrtl.uint<3>) -> !firrtl.uint<33>
      %_exec1Reg_result_T_1 = firrtl.bits %_exec1Reg_result_T 31 to 0 {name = "_exec1Reg_result_T_1"} : (!firrtl.uint<33>) -> !firrtl.uint<32>
      %_exec1Reg_ctrlTarget_T = firrtl.asSInt %449 {name = "_exec1Reg_ctrlTarget_T"} : (!firrtl.uint<32>) -> !firrtl.sint<32>
      %_exec1Reg_ctrlTarget_T_1 = firrtl.asSInt %443 {name = "_exec1Reg_ctrlTarget_T_1"} : (!firrtl.uint<32>) -> !firrtl.sint<32>
      ...
      %_target_T = firrtl.asSInt %433 {name = "_target_T"} : (!firrtl.uint<32>) -> !firrtl.sint<32>
      %_target_T_1 = firrtl.asSInt %443 {name = "_target_T_1"} : (!firrtl.uint<32>) -> !firrtl.sint<32>
      ...
      %_exec1Reg_result_T_2 = firrtl.add %449, %c4_ui3 {name = "_exec1Reg_result_T_2"} : (!firrtl.uint<32>, !firrtl.uint<3>) -> !firrtl.uint<33>
      %_exec1Reg_result_T_3 = firrtl.bits %_exec1Reg_result_T_2 31 to 0 {name = "_exec1Reg_result_T_3"} : (!firrtl.uint<33>) -> !firrtl.uint<32>
      %599 = firrtl.mux(%439, %433, %c0_ui32) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %600 = firrtl.or %441, %440 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %601 = firrtl.or %isMulInstr, %600 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %602 = firrtl.or %591, %601 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %603 = firrtl.mux(%602, %c0_ui32, %599) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %604 = firrtl.mux(%451, %603, %c0_ui32) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %605 = firrtl.mux(%439, %432, %c0_ui32) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %606 = firrtl.or %441, %440 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %607 = firrtl.or %isMulInstr, %606 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %608 = firrtl.or %591, %607 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %609 = firrtl.mux(%608, %c0_ui32, %605) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %610 = firrtl.mux(%451, %609, %c0_ui32) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %611 = firrtl.mux(%439, %449, %c0_ui32) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %612 = firrtl.or %441, %440 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %613 = firrtl.or %isMulInstr, %612 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %614 = firrtl.or %591, %613 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %615 = firrtl.mux(%614, %c0_ui32, %611) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %616 = firrtl.mux(%451, %615, %c0_ui32) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %_branchUnit_io_imm_T = firrtl.shl %443, 1 {name = "_branchUnit_io_imm_T"} : (!firrtl.uint<32>) -> !firrtl.uint<33>
      %_branchUnit_io_imm_T_1 = firrtl.asSInt %_branchUnit_io_imm_T {name = "_branchUnit_io_imm_T_1"} : (!firrtl.uint<33>) -> !firrtl.sint<33>
      %617 = firrtl.bits %_branchUnit_io_imm_T_1 31 to 0 : (!firrtl.sint<33>) -> !firrtl.uint<32>
      %618 = firrtl.asSInt %617 : (!firrtl.uint<32>) -> !firrtl.sint<32>
      %619 = firrtl.mux(%439, %618, %c0_si32) : (!firrtl.uint<1>, !firrtl.sint<32>, !firrtl.sint<32>) -> !firrtl.sint<32>
      %620 = firrtl.or %441, %440 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %621 = firrtl.or %isMulInstr, %620 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %622 = firrtl.or %591, %621 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %623 = firrtl.mux(%622, %c0_si32, %619) : (!firrtl.uint<1>, !firrtl.sint<32>, !firrtl.sint<32>) -> !firrtl.sint<32>
      %624 = firrtl.mux(%451, %623, %c0_si32) : (!firrtl.uint<1>, !firrtl.sint<32>, !firrtl.sint<32>) -> !firrtl.sint<32>
      %625 = firrtl.mux(%439, %funct3, %c0_ui3) : (!firrtl.uint<1>, !firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<3>
      %626 = firrtl.or %441, %440 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %627 = firrtl.or %isMulInstr, %626 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %628 = firrtl.or %591, %627 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %629 = firrtl.mux(%628, %c0_ui3, %625) : (!firrtl.uint<1>, !firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<3>
      %630 = firrtl.mux(%451, %629, %c0_ui3) : (!firrtl.uint<1>, !firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<3>
      %631 = firrtl.or %441, %440 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %632 = firrtl.or %isMulInstr, %631 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %633 = firrtl.or %591, %632 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %634 = firrtl.mux(%633, %c0_ui1, %439) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %635 = firrtl.mux(%451, %634, %c0_ui1) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %636 = firrtl.bundlecreate %604, %610, %616, %624, %630, %635, %branchUnit_io_taken, %branchUnit_io_target, %branchUnit_io_nextPc, %branchUnit_io_misaligned : (!firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.sint<32>, !firrtl.uint<3>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<1>) -> !firrtl.bundle<rs1: uint<32>, rs2: uint<32>, pc: uint<32>, imm: sint<32>, branchOp: uint<3>, valid: uint<1>, taken: uint<1>, target: uint<32>, nextPc: uint<32>, misaligned: uint<1>>
      firrtl.matchingconnect %branchUnit.io, %636 : !firrtl.bundle<rs1: uint<32>, rs2: uint<32>, pc: uint<32>, imm: sint<32>, branchOp: uint<3>, valid: uint<1>, taken: uint<1>, target: uint<32>, nextPc: uint<32>, misaligned: uint<1>>
      %637 = firrtl.mux(%439, %126, %c0_ui1) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %638 = firrtl.or %441, %440 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %639 = firrtl.mux(%638, %c1_ui1, %637) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %640 = firrtl.or %591, %isMulInstr : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %641 = firrtl.mux(%640, %c0_ui1, %639) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %642 = firrtl.mux(%451, %641, %528) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %643 = firrtl.mux(%439, %127, %c0_ui32) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %644 = firrtl.mux(%440, %target, %643) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %645 = firrtl.mux(%441, %_exec1Reg_ctrlTarget_T_5, %644) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %646 = firrtl.or %591, %isMulInstr : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %647 = firrtl.mux(%646, %c0_ui32, %645) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %648 = firrtl.mux(%451, %647, %529) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %_address_T = firrtl.add %433, %443 {name = "_address_T"} : (!firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<33>
      ...
      %649 = firrtl.subaccess %io_threadEnable_0[%448] : !firrtl.vector<uint<1>, 8>, !firrtl.uint<3>
      %650 = firrtl.mux(%438, %address, %c0_ui32) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %651 = firrtl.or %440, %439 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %652 = firrtl.or %441, %651 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %653 = firrtl.or %isMulInstr, %652 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %654 = firrtl.or %591, %653 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %655 = firrtl.mux(%654, %c0_ui32, %650) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %656 = firrtl.mux(%451, %655, %c0_ui32) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %657 = firrtl.mux(%438, %funct3, %c0_ui3) : (!firrtl.uint<1>, !firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<3>
      %658 = firrtl.or %440, %439 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %659 = firrtl.or %441, %658 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %660 = firrtl.or %isMulInstr, %659 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %661 = firrtl.or %591, %660 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %662 = firrtl.mux(%661, %c0_ui3, %657) : (!firrtl.uint<1>, !firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<3>
      %663 = firrtl.mux(%451, %662, %c0_ui3) : (!firrtl.uint<1>, !firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<3>
      %664 = firrtl.bundlecreate %656, %io_dataMemResp, %663, %loadUnit_io_dataOut : (!firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<3>, !firrtl.uint<32>) -> !firrtl.bundle<addr: uint<32>, dataIn: uint<32>, funct3: uint<3>, dataOut: uint<32>>
      firrtl.matchingconnect %loadUnit.io, %664 : !firrtl.bundle<addr: uint<32>, dataIn: uint<32>, funct3: uint<3>, dataOut: uint<32>>
      %665 = firrtl.mux(%438, %133, %526) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %666 = firrtl.mux(%439, %526, %665) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %667 = firrtl.mux(%440, %_exec1Reg_result_T_3, %666) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %668 = firrtl.mux(%441, %_exec1Reg_result_T_1, %667) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %669 = firrtl.mux(%isMulInstr, %c0_ui32, %668) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %670 = firrtl.mux(%591, %result, %669) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %671 = firrtl.mux(%451, %670, %526) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %672 = firrtl.mux(%439, %c0_ui1, %438) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %673 = firrtl.or %441, %440 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %674 = firrtl.or %isMulInstr, %673 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %675 = firrtl.or %591, %674 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %676 = firrtl.mux(%675, %c1_ui1, %672) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %677 = firrtl.mux(%451, %676, %527) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %_address_T_1 = firrtl.add %433, %443 {name = "_address_T_1"} : (!firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<33>
      %address_1 = firrtl.bits %_address_T_1 31 to 0 {name = "address_1"} : (!firrtl.uint<33>) -> !firrtl.uint<32>
      %_storeActive_T = firrtl.not %139 {name = "_storeActive_T"} : (!firrtl.uint<1>) -> !firrtl.uint<1>
      %678 = firrtl.subaccess %io_threadEnable_0[%448] : !firrtl.vector<uint<1>, 8>, !firrtl.uint<3>
      %storeActive = firrtl.and %678, %_storeActive_T {name = "storeActive"} : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      ...
      %679 = firrtl.mux(%437, %_io_memAddr_T_3, %c0_ui32) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %680 = firrtl.mux(%438, %_io_memAddr_T_1, %679) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %681 = firrtl.or %440, %439 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %682 = firrtl.or %441, %681 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %683 = firrtl.or %isMulInstr, %682 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %684 = firrtl.or %591, %683 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %685 = firrtl.mux(%684, %c0_ui32, %680) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %686 = firrtl.mux(%451, %685, %c0_ui32) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      firrtl.matchingconnect %io_memAddr_1, %686 : !firrtl.uint<32>
      %687 = firrtl.mux(%437, %address_1, %c0_ui32) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %688 = firrtl.or %439, %438 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %689 = firrtl.or %440, %688 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %690 = firrtl.or %441, %689 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %691 = firrtl.or %isMulInstr, %690 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %692 = firrtl.or %591, %691 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %693 = firrtl.mux(%692, %c0_ui32, %687) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %694 = firrtl.mux(%451, %693, %c0_ui32) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %695 = firrtl.mux(%437, %432, %c0_ui32) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %696 = firrtl.or %439, %438 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %697 = firrtl.or %440, %696 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %698 = firrtl.or %441, %697 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %699 = firrtl.or %isMulInstr, %698 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %700 = firrtl.or %591, %699 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %701 = firrtl.mux(%700, %c0_ui32, %695) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %702 = firrtl.mux(%451, %701, %c0_ui32) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %_storeUnit_io_storeType_T = firrtl.bits %450 13 to 12 {name = "_storeUnit_io_storeType_T"} : (!firrtl.uint<32>) -> !firrtl.uint<2>
      %703 = firrtl.mux(%437, %_storeUnit_io_storeType_T, %c0_ui2) : (!firrtl.uint<1>, !firrtl.uint<2>, !firrtl.uint<2>) -> !firrtl.uint<2>
      %704 = firrtl.or %439, %438 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %705 = firrtl.or %440, %704 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %706 = firrtl.or %441, %705 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %707 = firrtl.or %isMulInstr, %706 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %708 = firrtl.or %591, %707 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %709 = firrtl.mux(%708, %c0_ui2, %703) : (!firrtl.uint<1>, !firrtl.uint<2>, !firrtl.uint<2>) -> !firrtl.uint<2>
      %710 = firrtl.mux(%451, %709, %c0_ui2) : (!firrtl.uint<1>, !firrtl.uint<2>, !firrtl.uint<2>) -> !firrtl.uint<2>
      %711 = firrtl.bundlecreate %694, %702, %710, %storeUnit_io_memWrite, %storeUnit_io_mask, %storeUnit_io_misaligned : (!firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<2>, !firrtl.uint<32>, !firrtl.uint<4>, !firrtl.uint<1>) -> !firrtl.bundle<addr: uint<32>, data: uint<32>, storeType: uint<2>, memWrite: uint<32>, mask: uint<4>, misaligned: uint<1>>
      firrtl.matchingconnect %storeUnit.io, %711 : !firrtl.bundle<addr: uint<32>, data: uint<32>, storeType: uint<2>, memWrite: uint<32>, mask: uint<4>, misaligned: uint<1>>
      %712 = firrtl.and %437, %storeActive : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %713 = firrtl.mux(%712, %137, %c0_ui32) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %714 = firrtl.or %439, %438 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %715 = firrtl.or %440, %714 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %716 = firrtl.or %441, %715 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %717 = firrtl.or %isMulInstr, %716 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %718 = firrtl.or %591, %717 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %719 = firrtl.mux(%718, %c0_ui32, %713) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %720 = firrtl.mux(%451, %719, %c0_ui32) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      firrtl.matchingconnect %io_memWrite_2, %720 : !firrtl.uint<32>
      %721 = firrtl.and %437, %storeActive : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %722 = firrtl.mux(%721, %138, %c0_ui4) : (!firrtl.uint<1>, !firrtl.uint<4>, !firrtl.uint<4>) -> !firrtl.uint<4>
      %723 = firrtl.or %439, %438 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %724 = firrtl.or %440, %723 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %725 = firrtl.or %441, %724 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %726 = firrtl.or %isMulInstr, %725 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %727 = firrtl.or %591, %726 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %728 = firrtl.mux(%727, %c0_ui4, %722) : (!firrtl.uint<1>, !firrtl.uint<4>, !firrtl.uint<4>) -> !firrtl.uint<4>
      %729 = firrtl.mux(%451, %728, %c0_ui4) : (!firrtl.uint<1>, !firrtl.uint<4>, !firrtl.uint<4>) -> !firrtl.uint<4>
      firrtl.matchingconnect %io_memMask_3, %729 : !firrtl.uint<4>
      %730 = firrtl.mux(%437, %storeActive, %c0_ui1) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %731 = firrtl.mux(%438, %649, %730) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %732 = firrtl.or %440, %439 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %733 = firrtl.or %441, %732 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %734 = firrtl.or %isMulInstr, %733 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %735 = firrtl.or %591, %734 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %736 = firrtl.mux(%735, %c0_ui1, %731) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %737 = firrtl.mux(%451, %736, %c0_ui1) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      firrtl.matchingconnect %io_memValid_4, %737 : !firrtl.uint<1>
      %_io_memMisaligned_T = firrtl.and %678, %139 {name = "_io_memMisaligned_T"} : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %738 = firrtl.mux(%437, %_io_memMisaligned_T, %c0_ui1) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %739 = firrtl.or %439, %438 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %740 = firrtl.or %440, %739 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %741 = firrtl.or %441, %740 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %742 = firrtl.or %isMulInstr, %741 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %743 = firrtl.or %591, %742 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %744 = firrtl.mux(%743, %c0_ui1, %738) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %745 = firrtl.mux(%451, %744, %c0_ui1) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      firrtl.matchingconnect %io_memMisaligned_5, %745 : !firrtl.uint<1>
      %746 = firrtl.mux(%451, %541, %c0_ui1) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      ...
      %747 = firrtl.subfield %exec2Reg[exec1Signals] : !firrtl.bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>
      %748 = firrtl.subfield %747[regReadSignals] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %749 = firrtl.subfield %748[dispatchSignals] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %750 = firrtl.subfield %749[decodePipelineSignals] : !firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>
      %751 = firrtl.subfield %750[fetchSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %752 = firrtl.subfield %751[threadId] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %753 = firrtl.subfield %751[pc] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %754 = firrtl.subfield %751[instr] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %755 = firrtl.subfield %750[decodeSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %756 = firrtl.subfield %755[isALU] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %757 = firrtl.subfield %755[isLoad] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %758 = firrtl.subfield %755[isStore] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %759 = firrtl.subfield %755[isBranch] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %760 = firrtl.subfield %755[isJAL] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %761 = firrtl.subfield %755[isJALR] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %762 = firrtl.subfield %755[isLUI] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %763 = firrtl.subfield %755[isAUIPC] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %764 = firrtl.subfield %755[isSystem] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %765 = firrtl.subfield %755[isFence] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %766 = firrtl.subfield %755[usesImm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %767 = firrtl.subfield %755[rs1] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %768 = firrtl.subfield %755[rs2] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %769 = firrtl.subfield %755[rd] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %770 = firrtl.subfield %755[aluOp] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %771 = firrtl.subfield %755[imm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %772 = firrtl.subfield %748[rs1Data] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %773 = firrtl.subfield %748[rs2Data] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %774 = firrtl.subfield %747[result] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %775 = firrtl.subfield %747[doRegFileWrite] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %776 = firrtl.subfield %747[ctrlTaken] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %777 = firrtl.subfield %747[ctrlTarget] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %778 = firrtl.subfield %exec2Reg[exec1Signals] : !firrtl.bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>
      %779 = firrtl.subfield %778[regReadSignals] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %780 = firrtl.subfield %779[dispatchSignals] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %781 = firrtl.subfield %780[decodePipelineSignals] : !firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>
      %782 = firrtl.subfield %781[fetchSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %783 = firrtl.subfield %782[threadId] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %784 = firrtl.subfield %782[valid] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %785 = firrtl.subfield %exec1Reg[regReadSignals] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %786 = firrtl.subfield %785[dispatchSignals] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %787 = firrtl.subfield %786[decodePipelineSignals] : !firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>
      %788 = firrtl.subfield %787[fetchSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %789 = firrtl.subfield %788[valid] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %790 = firrtl.subfield %788[threadId] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %791 = firrtl.mux(%537, %790, %752) : (!firrtl.uint<1>, !firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<3>
      %792 = firrtl.subfield %788[pc] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %793 = firrtl.mux(%537, %792, %753) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %794 = firrtl.subfield %788[instr] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %795 = firrtl.mux(%537, %794, %754) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %796 = firrtl.subfield %787[decodeSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %797 = firrtl.subfield %796[isALU] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %798 = firrtl.mux(%537, %797, %756) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %799 = firrtl.subfield %796[isLoad] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %800 = firrtl.mux(%537, %799, %757) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %801 = firrtl.subfield %796[isStore] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %802 = firrtl.mux(%537, %801, %758) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %803 = firrtl.subfield %796[isBranch] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %804 = firrtl.mux(%537, %803, %759) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %805 = firrtl.subfield %796[isJAL] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %806 = firrtl.mux(%537, %805, %760) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %807 = firrtl.subfield %796[isJALR] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %808 = firrtl.mux(%537, %807, %761) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %809 = firrtl.subfield %796[isLUI] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %810 = firrtl.mux(%537, %809, %762) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %811 = firrtl.subfield %796[isAUIPC] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %812 = firrtl.mux(%537, %811, %763) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %813 = firrtl.subfield %796[isSystem] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %814 = firrtl.mux(%537, %813, %764) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %815 = firrtl.subfield %796[isFence] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %816 = firrtl.mux(%537, %815, %765) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %817 = firrtl.subfield %796[usesImm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %818 = firrtl.mux(%537, %817, %766) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %819 = firrtl.subfield %796[rs1] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %820 = firrtl.mux(%537, %819, %767) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %821 = firrtl.subfield %796[rs2] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %822 = firrtl.mux(%537, %821, %768) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %823 = firrtl.subfield %796[rd] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %824 = firrtl.mux(%537, %823, %769) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %825 = firrtl.subfield %796[aluOp] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %826 = firrtl.mux(%537, %825, %770) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %827 = firrtl.subfield %796[imm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %828 = firrtl.mux(%537, %827, %771) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %829 = firrtl.subfield %785[rs1Data] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %830 = firrtl.mux(%537, %829, %772) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %831 = firrtl.subfield %785[rs2Data] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %832 = firrtl.mux(%537, %831, %773) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %833 = firrtl.subfield %exec1Reg[result] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %834 = firrtl.mux(%537, %833, %774) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %835 = firrtl.subfield %exec1Reg[doRegFileWrite] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %836 = firrtl.mux(%537, %835, %775) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %837 = firrtl.subfield %exec1Reg[ctrlTaken] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %838 = firrtl.mux(%537, %837, %776) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %839 = firrtl.subfield %exec1Reg[ctrlTarget] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %840 = firrtl.mux(%537, %839, %777) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %841 = firrtl.mux(%537, %789, %c0_ui1) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      ...
      %842 = firrtl.subfield %exec3Reg[exec2Signals] : !firrtl.bundle<exec2Signals: bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>>
      %843 = firrtl.subfield %842[exec1Signals] : !firrtl.bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>
      %844 = firrtl.subfield %843[regReadSignals] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %845 = firrtl.subfield %844[dispatchSignals] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %846 = firrtl.subfield %845[decodePipelineSignals] : !firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>
      %847 = firrtl.subfield %846[fetchSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %848 = firrtl.subfield %847[threadId] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %849 = firrtl.subfield %847[pc] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %850 = firrtl.subfield %847[instr] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %851 = firrtl.subfield %846[decodeSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %852 = firrtl.subfield %851[isALU] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %853 = firrtl.subfield %851[isLoad] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %854 = firrtl.subfield %851[isStore] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %855 = firrtl.subfield %851[isBranch] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %856 = firrtl.subfield %851[isJAL] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %857 = firrtl.subfield %851[isJALR] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %858 = firrtl.subfield %851[isLUI] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %859 = firrtl.subfield %851[isAUIPC] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %860 = firrtl.subfield %851[isSystem] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %861 = firrtl.subfield %851[isFence] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %862 = firrtl.subfield %851[usesImm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %863 = firrtl.subfield %851[rs1] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %864 = firrtl.subfield %851[rs2] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %865 = firrtl.subfield %851[rd] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %866 = firrtl.subfield %851[aluOp] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %867 = firrtl.subfield %851[imm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %868 = firrtl.subfield %844[rs1Data] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %869 = firrtl.subfield %844[rs2Data] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %870 = firrtl.subfield %843[result] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %871 = firrtl.subfield %843[doRegFileWrite] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %872 = firrtl.subfield %843[ctrlTaken] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %873 = firrtl.subfield %843[ctrlTarget] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %874 = firrtl.subfield %exec3Reg[exec2Signals] : !firrtl.bundle<exec2Signals: bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>>
      %875 = firrtl.subfield %874[exec1Signals] : !firrtl.bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>
      %876 = firrtl.subfield %875[regReadSignals] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %877 = firrtl.subfield %876[dispatchSignals] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %878 = firrtl.subfield %877[decodePipelineSignals] : !firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>
      %879 = firrtl.subfield %878[fetchSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %880 = firrtl.subfield %879[threadId] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %881 = firrtl.subfield %879[valid] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %882 = firrtl.subfield %exec2Reg[exec1Signals] : !firrtl.bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>
      %883 = firrtl.subfield %882[regReadSignals] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %884 = firrtl.subfield %883[dispatchSignals] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %885 = firrtl.subfield %884[decodePipelineSignals] : !firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>
      %886 = firrtl.subfield %885[fetchSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %887 = firrtl.subfield %886[valid] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %888 = firrtl.subfield %886[threadId] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %889 = firrtl.mux(%784, %888, %848) : (!firrtl.uint<1>, !firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<3>
      %890 = firrtl.subfield %886[pc] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %891 = firrtl.mux(%784, %890, %849) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %892 = firrtl.subfield %886[instr] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %893 = firrtl.mux(%784, %892, %850) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %894 = firrtl.subfield %885[decodeSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %895 = firrtl.subfield %894[isALU] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %896 = firrtl.mux(%784, %895, %852) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %897 = firrtl.subfield %894[isLoad] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %898 = firrtl.mux(%784, %897, %853) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %899 = firrtl.subfield %894[isStore] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %900 = firrtl.mux(%784, %899, %854) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %901 = firrtl.subfield %894[isBranch] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %902 = firrtl.mux(%784, %901, %855) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %903 = firrtl.subfield %894[isJAL] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %904 = firrtl.mux(%784, %903, %856) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %905 = firrtl.subfield %894[isJALR] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %906 = firrtl.mux(%784, %905, %857) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %907 = firrtl.subfield %894[isLUI] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %908 = firrtl.mux(%784, %907, %858) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %909 = firrtl.subfield %894[isAUIPC] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %910 = firrtl.mux(%784, %909, %859) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %911 = firrtl.subfield %894[isSystem] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %912 = firrtl.mux(%784, %911, %860) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %913 = firrtl.subfield %894[isFence] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %914 = firrtl.mux(%784, %913, %861) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %915 = firrtl.subfield %894[usesImm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %916 = firrtl.mux(%784, %915, %862) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %917 = firrtl.subfield %894[rs1] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %918 = firrtl.mux(%784, %917, %863) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %919 = firrtl.subfield %894[rs2] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %920 = firrtl.mux(%784, %919, %864) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %921 = firrtl.subfield %894[rd] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %922 = firrtl.mux(%784, %921, %865) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %923 = firrtl.subfield %894[aluOp] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %924 = firrtl.mux(%784, %923, %866) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %925 = firrtl.subfield %894[imm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %926 = firrtl.mux(%784, %925, %867) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %927 = firrtl.subfield %883[rs1Data] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %928 = firrtl.mux(%784, %927, %868) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %929 = firrtl.subfield %883[rs2Data] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %930 = firrtl.mux(%784, %929, %869) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %931 = firrtl.subfield %882[result] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %932 = firrtl.mux(%784, %931, %870) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %933 = firrtl.subfield %882[doRegFileWrite] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %934 = firrtl.mux(%784, %933, %871) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %935 = firrtl.subfield %882[ctrlTaken] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %936 = firrtl.mux(%784, %935, %872) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %937 = firrtl.subfield %882[ctrlTarget] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %938 = firrtl.mux(%784, %937, %873) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %939 = firrtl.mux(%784, %887, %c0_ui1) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      ...
      %940 = firrtl.subfield %wbReg[exec3Signals] : !firrtl.bundle<exec3Signals: bundle<exec2Signals: bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>>>
      %941 = firrtl.subfield %940[exec2Signals] : !firrtl.bundle<exec2Signals: bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>>
      %942 = firrtl.subfield %941[exec1Signals] : !firrtl.bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>
      %943 = firrtl.subfield %942[regReadSignals] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %944 = firrtl.subfield %943[dispatchSignals] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %945 = firrtl.subfield %944[decodePipelineSignals] : !firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>
      %946 = firrtl.subfield %945[fetchSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %947 = firrtl.subfield %946[threadId] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %948 = firrtl.subfield %946[pc] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %949 = firrtl.subfield %946[instr] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %950 = firrtl.subfield %945[decodeSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %951 = firrtl.subfield %950[isALU] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %952 = firrtl.subfield %950[isLoad] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %953 = firrtl.subfield %950[isStore] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %954 = firrtl.subfield %950[isBranch] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %955 = firrtl.subfield %950[isJAL] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %956 = firrtl.subfield %950[isJALR] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %957 = firrtl.subfield %950[isLUI] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %958 = firrtl.subfield %950[isAUIPC] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %959 = firrtl.subfield %950[isSystem] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %960 = firrtl.subfield %950[isFence] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %961 = firrtl.subfield %950[usesImm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %962 = firrtl.subfield %950[rs1] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %963 = firrtl.subfield %950[rs2] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %964 = firrtl.subfield %950[rd] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %965 = firrtl.subfield %950[aluOp] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %966 = firrtl.subfield %950[imm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %967 = firrtl.subfield %943[rs1Data] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %968 = firrtl.subfield %943[rs2Data] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %969 = firrtl.subfield %942[result] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %970 = firrtl.subfield %942[doRegFileWrite] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %971 = firrtl.subfield %942[ctrlTaken] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %972 = firrtl.subfield %942[ctrlTarget] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %973 = firrtl.subfield %wbReg[exec3Signals] : !firrtl.bundle<exec3Signals: bundle<exec2Signals: bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>>>
      %974 = firrtl.subfield %973[exec2Signals] : !firrtl.bundle<exec2Signals: bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>>
      %975 = firrtl.subfield %974[exec1Signals] : !firrtl.bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>
      %976 = firrtl.subfield %975[ctrlTarget] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %977 = firrtl.subfield %975[ctrlTaken] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %978 = firrtl.subfield %975[result] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %979 = firrtl.subfield %975[doRegFileWrite] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %980 = firrtl.subfield %975[regReadSignals] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %981 = firrtl.subfield %980[dispatchSignals] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %982 = firrtl.subfield %981[decodePipelineSignals] : !firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>
      %983 = firrtl.subfield %982[decodeSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %984 = firrtl.subfield %983[isJALR] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %985 = firrtl.subfield %983[isJAL] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %986 = firrtl.subfield %983[isBranch] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %987 = firrtl.subfield %983[rd] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %988 = firrtl.subfield %982[fetchSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %989 = firrtl.subfield %988[pc] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %990 = firrtl.subfield %988[threadId] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %991 = firrtl.subfield %988[instr] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %992 = firrtl.subfield %988[valid] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %993 = firrtl.subfield %exec3Reg[exec2Signals] : !firrtl.bundle<exec2Signals: bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>>
      %994 = firrtl.subfield %993[exec1Signals] : !firrtl.bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>
      %995 = firrtl.subfield %994[regReadSignals] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %996 = firrtl.subfield %995[dispatchSignals] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %997 = firrtl.subfield %996[decodePipelineSignals] : !firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>
      %998 = firrtl.subfield %997[fetchSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %999 = firrtl.subfield %998[valid] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %1000 = firrtl.subfield %998[threadId] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %1001 = firrtl.mux(%881, %1000, %947) : (!firrtl.uint<1>, !firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<3>
      %1002 = firrtl.subfield %998[pc] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %1003 = firrtl.mux(%881, %1002, %948) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1004 = firrtl.subfield %998[instr] : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %1005 = firrtl.mux(%881, %1004, %949) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1006 = firrtl.subfield %997[decodeSignals] : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %1007 = firrtl.subfield %1006[isALU] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %1008 = firrtl.mux(%881, %1007, %951) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1009 = firrtl.subfield %1006[isLoad] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %1010 = firrtl.mux(%881, %1009, %952) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1011 = firrtl.subfield %1006[isStore] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %1012 = firrtl.mux(%881, %1011, %953) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1013 = firrtl.subfield %1006[isBranch] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %1014 = firrtl.mux(%881, %1013, %954) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1015 = firrtl.subfield %1006[isJAL] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %1016 = firrtl.mux(%881, %1015, %955) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1017 = firrtl.subfield %1006[isJALR] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %1018 = firrtl.mux(%881, %1017, %956) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1019 = firrtl.subfield %1006[isLUI] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %1020 = firrtl.mux(%881, %1019, %957) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1021 = firrtl.subfield %1006[isAUIPC] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %1022 = firrtl.mux(%881, %1021, %958) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1023 = firrtl.subfield %1006[isSystem] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %1024 = firrtl.mux(%881, %1023, %959) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1025 = firrtl.subfield %1006[isFence] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %1026 = firrtl.mux(%881, %1025, %960) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1027 = firrtl.subfield %1006[usesImm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %1028 = firrtl.mux(%881, %1027, %961) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1029 = firrtl.subfield %1006[rs1] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %1030 = firrtl.mux(%881, %1029, %962) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %1031 = firrtl.subfield %1006[rs2] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %1032 = firrtl.mux(%881, %1031, %963) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %1033 = firrtl.subfield %1006[rd] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %1034 = firrtl.mux(%881, %1033, %964) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %1035 = firrtl.subfield %1006[aluOp] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %1036 = firrtl.mux(%881, %1035, %965) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %1037 = firrtl.subfield %1006[imm] : !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %1038 = firrtl.mux(%881, %1037, %966) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1039 = firrtl.subfield %995[rs1Data] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %1040 = firrtl.mux(%881, %1039, %967) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1041 = firrtl.subfield %995[rs2Data] : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %1042 = firrtl.mux(%881, %1041, %968) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1043 = firrtl.subfield %994[result] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %1044 = firrtl.mux(%881, %1043, %969) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1045 = firrtl.subfield %994[doRegFileWrite] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %1046 = firrtl.mux(%881, %1045, %970) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1047 = firrtl.subfield %994[ctrlTaken] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %1048 = firrtl.mux(%881, %1047, %971) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1049 = firrtl.subfield %994[ctrlTarget] : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %1050 = firrtl.mux(%881, %1049, %972) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1051 = firrtl.mux(%881, %999, %c0_ui1) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %_isMExt_WB_T = firrtl.bits %991 6 to 0 {name = "_isMExt_WB_T"} : (!firrtl.uint<32>) -> !firrtl.uint<7>
      %_isMExt_WB_T_1 = firrtl.eq %_isMExt_WB_T, %c51_ui7 {name = "_isMExt_WB_T_1"} : (!firrtl.uint<7>, !firrtl.uint<7>) -> !firrtl.uint<1>
      %_isMExt_WB_T_2 = firrtl.bits %991 31 to 25 {name = "_isMExt_WB_T_2"} : (!firrtl.uint<32>) -> !firrtl.uint<7>
      ...
      %mulFunct3_WB = firrtl.bits %991 14 to 12 {name = "mulFunct3_WB"} : (!firrtl.uint<32>) -> !firrtl.uint<3>
      ...
      %1052 = firrtl.or %_mulResult_WB_T_4, %_mulResult_WB_T_2 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %_mulResult_WB_T_6 = firrtl.eq %mulFunct3_WB, %c3_ui2 {name = "_mulResult_WB_T_6"} : (!firrtl.uint<3>, !firrtl.uint<2>) -> !firrtl.uint<1>
      %1053 = firrtl.or %_mulResult_WB_T_6, %1052 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %mulResult_WB = firrtl.mux(%1053, %119, %_mulResult_WB_T_1) {name = "mulResult_WB"} : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1054 = firrtl.and %992, %979 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1055 = firrtl.orr %987 : (!firrtl.uint<5>) -> !firrtl.uint<1>
      %1056 = firrtl.and %1054, %1055 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %writeData = firrtl.mux(%isMulInstr_WB, %mulResult_WB, %978) {name = "writeData"} : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1057 = firrtl.mux(%1056, %990, %c0_ui3) : (!firrtl.uint<1>, !firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<3>
      %1058 = firrtl.mux(%1056, %987, %c0_ui5) : (!firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.uint<5>
      %1059 = firrtl.mux(%1056, %writeData, %c0_ui32) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %ex1Redirect = firrtl.and %537, %531 {name = "ex1Redirect"} : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1060 = firrtl.orr %536 : (!firrtl.uint<3>) -> !firrtl.uint<1>
      %1061 = firrtl.not %1060 : (!firrtl.uint<1>) -> !firrtl.uint<1>
      %1062 = firrtl.and %ex1Redirect, %1061 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1063 = firrtl.mux(%1062, %530, %154) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1064 = firrtl.eq %536, %c1_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %1065 = firrtl.and %ex1Redirect, %1064 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1066 = firrtl.mux(%1065, %530, %157) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1067 = firrtl.eq %536, %c2_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %1068 = firrtl.and %ex1Redirect, %1067 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1069 = firrtl.mux(%1068, %530, %160) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1070 = firrtl.eq %536, %c3_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %1071 = firrtl.and %ex1Redirect, %1070 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1072 = firrtl.mux(%1071, %530, %163) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1073 = firrtl.eq %536, %c4_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %1074 = firrtl.and %ex1Redirect, %1073 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1075 = firrtl.mux(%1074, %530, %166) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1076 = firrtl.eq %536, %c5_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %1077 = firrtl.and %ex1Redirect, %1076 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1078 = firrtl.mux(%1077, %530, %169) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1079 = firrtl.eq %536, %c6_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %1080 = firrtl.and %ex1Redirect, %1079 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1081 = firrtl.mux(%1080, %530, %172) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1082 = firrtl.andr %536 : (!firrtl.uint<3>) -> !firrtl.uint<1>
      %1083 = firrtl.and %ex1Redirect, %1082 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1084 = firrtl.mux(%1083, %530, %175) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1085 = firrtl.vectorcreate %1063, %1066, %1069, %1072, %1075, %1078, %1081, %1084 : (!firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.vector<uint<32>, 8>
      firrtl.matchingconnect %pcRegs, %1085 : !firrtl.vector<uint<32>, 8>
      %1086 = firrtl.mux(%ex1Redirect, %c0_ui1, %146) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1087 = firrtl.bundlecreate %1086, %147, %149, %150 : (!firrtl.uint<1>, !firrtl.uint<3>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      firrtl.matchingconnect %fetchReg, %1087 : !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %1088 = firrtl.mux(%ex1Redirect, %c0_ui1, %335) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1089 = firrtl.bundlecreate %1088, %202, %204, %206 : (!firrtl.uint<1>, !firrtl.uint<3>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %1090 = firrtl.mux(%ex1Redirect, %c0_ui1, %406) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1091 = firrtl.bundlecreate %1090, %368, %370, %372 : (!firrtl.uint<1>, !firrtl.uint<3>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %1092 = firrtl.mux(%ex1Redirect, %c0_ui1, %499) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1093 = firrtl.bundlecreate %1092, %456, %458, %460 : (!firrtl.uint<1>, !firrtl.uint<3>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %1094 = firrtl.and %1054, %1055 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %writeData_1 = firrtl.mux(%isMulInstr_WB, %mulResult_WB, %978) {name = "writeData_1"} : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1095 = firrtl.eq %987, %c1_ui1 : (!firrtl.uint<5>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1096 = firrtl.orr %990 : (!firrtl.uint<3>) -> !firrtl.uint<1>
      ...
      %1100 = firrtl.mux(%1099, %writeData_1, %19) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1101 = firrtl.eq %990, %c1_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      ...
      %1104 = firrtl.mux(%1103, %writeData_1, %24) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1105 = firrtl.eq %990, %c2_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      ...
      %1108 = firrtl.mux(%1107, %writeData_1, %29) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1109 = firrtl.eq %990, %c3_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      ...
      %1112 = firrtl.mux(%1111, %writeData_1, %34) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1113 = firrtl.eq %990, %c4_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      ...
      %1116 = firrtl.mux(%1115, %writeData_1, %39) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1117 = firrtl.eq %990, %c5_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      ...
      %1120 = firrtl.mux(%1119, %writeData_1, %44) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1121 = firrtl.eq %990, %c6_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      ...
      %1124 = firrtl.mux(%1123, %writeData_1, %49) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1125 = firrtl.andr %990 : (!firrtl.uint<3>) -> !firrtl.uint<1>
      ...
      %1128 = firrtl.mux(%1127, %writeData_1, %54) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1129 = firrtl.eq %987, %c2_ui2 : (!firrtl.uint<5>, !firrtl.uint<2>) -> !firrtl.uint<1>
      %1130 = firrtl.orr %990 : (!firrtl.uint<3>) -> !firrtl.uint<1>
      %1131 = firrtl.not %1130 : (!firrtl.uint<1>) -> !firrtl.uint<1>
      %1132 = firrtl.and %1129, %1131 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1133 = firrtl.mux(%1132, %writeData_1, %20) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1134 = firrtl.mux(%1095, %20, %1133) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1135 = firrtl.mux(%1094, %1134, %20) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1136 = firrtl.eq %990, %c1_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %1137 = firrtl.and %1129, %1136 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1138 = firrtl.mux(%1137, %writeData_1, %25) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1139 = firrtl.mux(%1095, %25, %1138) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1140 = firrtl.mux(%1094, %1139, %25) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1141 = firrtl.eq %990, %c2_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %1142 = firrtl.and %1129, %1141 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1143 = firrtl.mux(%1142, %writeData_1, %30) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1144 = firrtl.mux(%1095, %30, %1143) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1145 = firrtl.mux(%1094, %1144, %30) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1146 = firrtl.eq %990, %c3_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %1147 = firrtl.and %1129, %1146 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1148 = firrtl.mux(%1147, %writeData_1, %35) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1149 = firrtl.mux(%1095, %35, %1148) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1150 = firrtl.mux(%1094, %1149, %35) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1151 = firrtl.eq %990, %c4_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %1152 = firrtl.and %1129, %1151 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1153 = firrtl.mux(%1152, %writeData_1, %40) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1154 = firrtl.mux(%1095, %40, %1153) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1155 = firrtl.mux(%1094, %1154, %40) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1156 = firrtl.eq %990, %c5_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %1157 = firrtl.and %1129, %1156 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1158 = firrtl.mux(%1157, %writeData_1, %45) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1159 = firrtl.mux(%1095, %45, %1158) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1160 = firrtl.mux(%1094, %1159, %45) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1161 = firrtl.eq %990, %c6_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %1162 = firrtl.and %1129, %1161 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1163 = firrtl.mux(%1162, %writeData_1, %50) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1164 = firrtl.mux(%1095, %50, %1163) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1165 = firrtl.mux(%1094, %1164, %50) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1166 = firrtl.andr %990 : (!firrtl.uint<3>) -> !firrtl.uint<1>
      %1167 = firrtl.and %1129, %1166 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1168 = firrtl.mux(%1167, %writeData_1, %55) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1169 = firrtl.mux(%1095, %55, %1168) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1170 = firrtl.mux(%1094, %1169, %55) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1171 = firrtl.eq %987, %c3_ui2 : (!firrtl.uint<5>, !firrtl.uint<2>) -> !firrtl.uint<1>
      %1172 = firrtl.orr %990 : (!firrtl.uint<3>) -> !firrtl.uint<1>
      %1173 = firrtl.not %1172 : (!firrtl.uint<1>) -> !firrtl.uint<1>
      %1174 = firrtl.and %1171, %1173 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1175 = firrtl.mux(%1174, %writeData_1, %21) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1176 = firrtl.or %1095, %1129 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1177 = firrtl.mux(%1176, %21, %1175) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1178 = firrtl.mux(%1094, %1177, %21) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1179 = firrtl.eq %990, %c1_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %1180 = firrtl.and %1171, %1179 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1181 = firrtl.mux(%1180, %writeData_1, %26) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1182 = firrtl.or %1095, %1129 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1183 = firrtl.mux(%1182, %26, %1181) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1184 = firrtl.mux(%1094, %1183, %26) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1185 = firrtl.eq %990, %c2_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %1186 = firrtl.and %1171, %1185 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1187 = firrtl.mux(%1186, %writeData_1, %31) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1188 = firrtl.or %1095, %1129 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1189 = firrtl.mux(%1188, %31, %1187) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1190 = firrtl.mux(%1094, %1189, %31) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1191 = firrtl.eq %990, %c3_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %1192 = firrtl.and %1171, %1191 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1193 = firrtl.mux(%1192, %writeData_1, %36) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1194 = firrtl.or %1095, %1129 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1195 = firrtl.mux(%1194, %36, %1193) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1196 = firrtl.mux(%1094, %1195, %36) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1197 = firrtl.eq %990, %c4_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %1198 = firrtl.and %1171, %1197 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1199 = firrtl.mux(%1198, %writeData_1, %41) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1200 = firrtl.or %1095, %1129 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1201 = firrtl.mux(%1200, %41, %1199) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1202 = firrtl.mux(%1094, %1201, %41) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1203 = firrtl.eq %990, %c5_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %1204 = firrtl.and %1171, %1203 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1205 = firrtl.mux(%1204, %writeData_1, %46) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1206 = firrtl.or %1095, %1129 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1207 = firrtl.mux(%1206, %46, %1205) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1208 = firrtl.mux(%1094, %1207, %46) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1209 = firrtl.eq %990, %c6_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %1210 = firrtl.and %1171, %1209 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1211 = firrtl.mux(%1210, %writeData_1, %51) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1212 = firrtl.or %1095, %1129 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1213 = firrtl.mux(%1212, %51, %1211) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1214 = firrtl.mux(%1094, %1213, %51) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1215 = firrtl.andr %990 : (!firrtl.uint<3>) -> !firrtl.uint<1>
      %1216 = firrtl.and %1171, %1215 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1217 = firrtl.mux(%1216, %writeData_1, %56) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1218 = firrtl.or %1095, %1129 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1219 = firrtl.mux(%1218, %56, %1217) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1220 = firrtl.mux(%1094, %1219, %56) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1221 = firrtl.eq %987, %c4_ui3 : (!firrtl.uint<5>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %1222 = firrtl.orr %990 : (!firrtl.uint<3>) -> !firrtl.uint<1>
      %1223 = firrtl.not %1222 : (!firrtl.uint<1>) -> !firrtl.uint<1>
      %1224 = firrtl.and %1221, %1223 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1225 = firrtl.mux(%1224, %writeData_1, %22) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      ...
      %1228 = firrtl.mux(%1227, %22, %1225) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1229 = firrtl.mux(%1094, %1228, %22) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      ...
      %1231 = firrtl.eq %990, %c1_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %1232 = firrtl.and %1221, %1231 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1233 = firrtl.mux(%1232, %writeData_1, %27) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      ...
      %1236 = firrtl.mux(%1235, %27, %1233) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1237 = firrtl.mux(%1094, %1236, %27) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      ...
      %1239 = firrtl.eq %990, %c2_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %1240 = firrtl.and %1221, %1239 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1241 = firrtl.mux(%1240, %writeData_1, %32) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      ...
      %1244 = firrtl.mux(%1243, %32, %1241) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1245 = firrtl.mux(%1094, %1244, %32) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      ...
      %1247 = firrtl.eq %990, %c3_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %1248 = firrtl.and %1221, %1247 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1249 = firrtl.mux(%1248, %writeData_1, %37) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      ...
      %1252 = firrtl.mux(%1251, %37, %1249) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1253 = firrtl.mux(%1094, %1252, %37) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      ...
      %1255 = firrtl.eq %990, %c4_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %1256 = firrtl.and %1221, %1255 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1257 = firrtl.mux(%1256, %writeData_1, %42) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      ...
      %1260 = firrtl.mux(%1259, %42, %1257) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1261 = firrtl.mux(%1094, %1260, %42) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      ...
      %1263 = firrtl.eq %990, %c5_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %1264 = firrtl.and %1221, %1263 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1265 = firrtl.mux(%1264, %writeData_1, %47) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      ...
      %1268 = firrtl.mux(%1267, %47, %1265) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1269 = firrtl.mux(%1094, %1268, %47) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      ...
      %1271 = firrtl.eq %990, %c6_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.uint<1>
      %1272 = firrtl.and %1221, %1271 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1273 = firrtl.mux(%1272, %writeData_1, %52) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      ...
      %1276 = firrtl.mux(%1275, %52, %1273) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1277 = firrtl.mux(%1094, %1276, %52) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      ...
      %1279 = firrtl.andr %990 : (!firrtl.uint<3>) -> !firrtl.uint<1>
      %1280 = firrtl.and %1221, %1279 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1281 = firrtl.mux(%1280, %writeData_1, %57) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      ...
      %1284 = firrtl.mux(%1283, %57, %1281) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      %1285 = firrtl.mux(%1094, %1284, %57) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
      ...
      %1288 = firrtl.orr %987 : (!firrtl.uint<5>) -> !firrtl.uint<1>
      %1289 = firrtl.not %1288 : (!firrtl.uint<1>) -> !firrtl.uint<1>
      %1290 = firrtl.and %1054, %1289 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      %1291 = firrtl.mux(%1290, %c0_ui1, %1056) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
      firrtl.matchingconnect %io_debugCtrlValid_11, %992 : !firrtl.uint<1>
      firrtl.matchingconnect %io_debugCtrlInstr_12, %991 : !firrtl.uint<32>
      firrtl.matchingconnect %io_debugCtrlTaken_13, %977 : !firrtl.uint<1>
      firrtl.matchingconnect %io_debugCtrlThread_14, %990 : !firrtl.uint<3>
      firrtl.matchingconnect %io_debugCtrlFromPC_15, %989 : !firrtl.uint<32>
      firrtl.matchingconnect %io_debugCtrlTarget_16, %976 : !firrtl.uint<32>
      firrtl.matchingconnect %io_debugCtrlIsBranch_17, %986 : !firrtl.uint<1>
      firrtl.matchingconnect %io_debugCtrlIsJal_18, %985 : !firrtl.uint<1>
      firrtl.matchingconnect %io_debugCtrlIsJalr_19, %984 : !firrtl.uint<1>
      %1292 = firrtl.vectorcreate %144, %198, %363, %448, %536, %783, %880, %990 : (!firrtl.uint<3>, !firrtl.uint<3>, !firrtl.uint<3>, !firrtl.uint<3>, !firrtl.uint<3>, !firrtl.uint<3>, !firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.vector<uint<3>, 8>
      firrtl.matchingconnect %io_debugStageThreads_6, %1292 : !firrtl.vector<uint<3>, 8>
      %1293 = firrtl.vectorcreate %145, %199, %364, %451, %537, %784, %881, %992 : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.vector<uint<1>, 8>
      firrtl.matchingconnect %io_debugStageValids_7, %1293 : !firrtl.vector<uint<1>, 8>
      firrtl.matchingconnect %io_debugPC_8, %pcRegs : !firrtl.vector<uint<32>, 8>
      %1294 = firrtl.vectorcreate %97, %92, %87, %82, %77, %72, %67, %62 : (!firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.vector<uint<32>, 8>
      firrtl.matchingconnect %io_debugRegX1_10, %1294 : !firrtl.vector<uint<32>, 8>
      firrtl.matchingconnect %io_debugRegs01234, %io_debugRegs01234_9 : !firrtl.vector<vector<uint<32>, 5>, 8>
      %1295 = firrtl.vectorcreate %c0_ui32, %62, %61, %60, %59 : (!firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.vector<uint<32>, 5>
      %1296 = firrtl.vectorcreate %c0_ui32, %67, %66, %65, %64 : (!firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.vector<uint<32>, 5>
      %1297 = firrtl.vectorcreate %c0_ui32, %72, %71, %70, %69 : (!firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.vector<uint<32>, 5>
      %1298 = firrtl.vectorcreate %c0_ui32, %77, %76, %75, %74 : (!firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.vector<uint<32>, 5>
      %1299 = firrtl.vectorcreate %c0_ui32, %82, %81, %80, %79 : (!firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.vector<uint<32>, 5>
      %1300 = firrtl.vectorcreate %c0_ui32, %87, %86, %85, %84 : (!firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.vector<uint<32>, 5>
      %1301 = firrtl.vectorcreate %c0_ui32, %92, %91, %90, %89 : (!firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.vector<uint<32>, 5>
      %1302 = firrtl.vectorcreate %c0_ui32, %97, %96, %95, %94 : (!firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.vector<uint<32>, 5>
      firrtl.matchingconnect %_debugRegs1to4_WIRE_8, %1 : !firrtl.vector<vector<uint<32>, 4>, 8>
      %unusedRegDebugX1 = firrtl.node %107 {annotations = [{circt.fieldID = 1 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 2 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 3 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 4 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 5 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 6 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 7 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 8 : i32, class = "firrtl.transforms.DontTouchAnnotation"}]} : !firrtl.vector<uint<32>, 8>
      ...
      %1303 = firrtl.vectorcreate %1302, %1301, %1300, %1299, %1298, %1297, %1296, %1295 : (!firrtl.vector<uint<32>, 5>, !firrtl.vector<uint<32>, 5>, !firrtl.vector<uint<32>, 5>, !firrtl.vector<uint<32>, 5>, !firrtl.vector<uint<32>, 5>, !firrtl.vector<uint<32>, 5>, !firrtl.vector<uint<32>, 5>, !firrtl.vector<uint<32>, 5>) -> !firrtl.vector<vector<uint<32>, 5>, 8>
      firrtl.matchingconnect %io_debugRegs01234_9, %1303 : !firrtl.vector<vector<uint<32>, 5>, 8>
      %1304 = firrtl.vectorcreate %494, %c0_ui3, %c0_ui3, %c0_ui3, %c0_ui3, %c0_ui3, %c0_ui3, %c0_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>, !firrtl.uint<3>, !firrtl.uint<3>, !firrtl.uint<3>, !firrtl.uint<3>, !firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.vector<uint<3>, 8>
      %1305 = firrtl.vectorcreate %495, %c0_ui5, %c0_ui5, %c0_ui5, %c0_ui5, %c0_ui5, %c0_ui5, %c0_ui5 : (!firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.vector<uint<5>, 8>
      %1306 = firrtl.vectorcreate %496, %c0_ui5, %c0_ui5, %c0_ui5, %c0_ui5, %c0_ui5, %c0_ui5, %c0_ui5 : (!firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.vector<uint<5>, 8>
      %1307 = firrtl.vectorcreate %1057, %c0_ui3, %c0_ui3, %c0_ui3 : (!firrtl.uint<3>, !firrtl.uint<3>, !firrtl.uint<3>, !firrtl.uint<3>) -> !firrtl.vector<uint<3>, 4>
      %1308 = firrtl.vectorcreate %1058, %c0_ui5, %c0_ui5, %c0_ui5 : (!firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>) -> !firrtl.vector<uint<5>, 4>
      %1309 = firrtl.vectorcreate %1291, %c0_ui1, %c0_ui1, %c0_ui1 : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.vector<uint<1>, 4>
      %1310 = firrtl.vectorcreate %1059, %c0_ui32, %c0_ui32, %c0_ui32 : (!firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.vector<uint<32>, 4>
      %1311 = firrtl.bundlecreate %1304, %1305, %1306, %regFile_io_src1data, %regFile_io_src2data, %1307, %1308, %1309, %1310, %regFile_io_debugX1, %regFile_io_debugRegs01234 : (!firrtl.vector<uint<3>, 8>, !firrtl.vector<uint<5>, 8>, !firrtl.vector<uint<5>, 8>, !firrtl.vector<uint<32>, 8>, !firrtl.vector<uint<32>, 8>, !firrtl.vector<uint<3>, 4>, !firrtl.vector<uint<5>, 4>, !firrtl.vector<uint<1>, 4>, !firrtl.vector<uint<32>, 4>, !firrtl.vector<uint<32>, 8>, !firrtl.vector<vector<uint<32>, 5>, 8>) -> !firrtl.bundle<readThreadID: vector<uint<3>, 8>, src1: vector<uint<5>, 8>, src2: vector<uint<5>, 8>, src1data: vector<uint<32>, 8>, src2data: vector<uint<32>, 8>, writeThreadID: vector<uint<3>, 4>, dst: vector<uint<5>, 4>, wen: vector<uint<1>, 4>, dstData: vector<uint<32>, 4>, debugX1: vector<uint<32>, 8>, debugRegs01234: vector<vector<uint<32>, 5>, 8>>
      firrtl.matchingconnect %regFile.io, %1311 : !firrtl.bundle<readThreadID: vector<uint<3>, 8>, src1: vector<uint<5>, 8>, src2: vector<uint<5>, 8>, src1data: vector<uint<32>, 8>, src2data: vector<uint<32>, 8>, writeThreadID: vector<uint<3>, 4>, dst: vector<uint<5>, 4>, wen: vector<uint<1>, 4>, dstData: vector<uint<32>, 4>, debugX1: vector<uint<32>, 8>, debugRegs01234: vector<vector<uint<32>, 5>, 8>>
      %unusedRegDebugRegs = firrtl.node %108 {annotations = [{circt.fieldID = 2 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 3 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 4 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 5 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 6 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 8 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 9 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 10 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 11 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 12 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 14 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 15 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 16 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 17 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 18 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 20 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 21 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 22 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 23 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 24 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 26 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 27 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 28 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 29 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 30 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 32 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 33 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 34 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 35 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 36 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 38 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 39 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 40 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 41 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 42 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 44 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 45 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 46 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 47 : i32, class = "firrtl.transforms.DontTouchAnnotation"}, {circt.fieldID = 48 : i32, class = "firrtl.transforms.DontTouchAnnotation"}]} : !firrtl.vector<vector<uint<32>, 5>, 8>
      %1312 = firrtl.bundlecreate %304, %306, %308, %310, %312, %314, %316, %318, %320, %322, %324, %326, %328, %330, %332, %334 : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<32>) -> !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %1313 = firrtl.bundlecreate %1089, %1312 : (!firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>) -> !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      firrtl.matchingconnect %decodeReg, %1313 : !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      ...
      %1314 = firrtl.bundlecreate %375, %377, %379, %381, %383, %385, %387, %389, %391, %393, %395, %397, %399, %401, %403, %405 : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<32>) -> !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %1315 = firrtl.bundlecreate %1091, %1314 : (!firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>) -> !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %1316 = firrtl.bundlecreate %1315 : (!firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>) -> !firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>
      firrtl.matchingconnect %dispatchReg, %1316 : !firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>
      %1317 = firrtl.bundlecreate %463, %465, %467, %469, %471, %473, %475, %477, %479, %481, %483, %485, %487, %489, %491, %493 : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<32>) -> !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %1318 = firrtl.bundlecreate %1093, %1317 : (!firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>) -> !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %1319 = firrtl.bundlecreate %1318 : (!firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>) -> !firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>
      %1320 = firrtl.bundlecreate %1319, %497, %498 : (!firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      firrtl.matchingconnect %regReadReg, %1320 : !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %1321 = firrtl.bundlecreate %746, %543, %545, %547 : (!firrtl.uint<1>, !firrtl.uint<3>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %1322 = firrtl.bundlecreate %550, %552, %554, %556, %558, %560, %562, %564, %566, %568, %570, %572, %574, %576, %578, %580 : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<32>) -> !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %1323 = firrtl.bundlecreate %841, %791, %793, %795 : (!firrtl.uint<1>, !firrtl.uint<3>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %1324 = firrtl.bundlecreate %798, %800, %802, %804, %806, %808, %810, %812, %814, %816, %818, %820, %822, %824, %826, %828 : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<32>) -> !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %1325 = firrtl.bundlecreate %939, %889, %891, %893 : (!firrtl.uint<1>, !firrtl.uint<3>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %1326 = firrtl.bundlecreate %896, %898, %900, %902, %904, %906, %908, %910, %912, %914, %916, %918, %920, %922, %924, %926 : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<32>) -> !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      %1327 = firrtl.bundlecreate %1051, %1001, %1003, %1005 : (!firrtl.uint<1>, !firrtl.uint<3>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>
      %1328 = firrtl.bundlecreate %1008, %1010, %1012, %1014, %1016, %1018, %1020, %1022, %1024, %1026, %1028, %1030, %1032, %1034, %1036, %1038 : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<5>, !firrtl.uint<32>) -> !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>
      ...
      %1329 = firrtl.bundlecreate %1321, %1322 : (!firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>) -> !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %1330 = firrtl.bundlecreate %1323, %1324 : (!firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>) -> !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %1331 = firrtl.bundlecreate %1325, %1326 : (!firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>) -> !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      %1332 = firrtl.bundlecreate %1327, %1328 : (!firrtl.bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, !firrtl.bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>) -> !firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>
      firrtl.matchingconnect %_exec1Reg_WIRE, %5 : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %1333 = firrtl.bundlecreate %1329 : (!firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>) -> !firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>
      %1334 = firrtl.bundlecreate %1333, %582, %584 : (!firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %1335 = firrtl.bundlecreate %1334, %671, %677, %642, %648 : (!firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, !firrtl.uint<32>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<32>) -> !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      firrtl.matchingconnect %exec1Reg, %1335 : !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %1336 = firrtl.bundlecreate %1330 : (!firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>) -> !firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>
      %1337 = firrtl.bundlecreate %1331 : (!firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>) -> !firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>
      %1338 = firrtl.bundlecreate %1332 : (!firrtl.bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>) -> !firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>
      firrtl.matchingconnect %_exec2Reg_WIRE, %4 : !firrtl.bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>
      %1339 = firrtl.bundlecreate %1336, %830, %832 : (!firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %1340 = firrtl.bundlecreate %1339, %834, %836, %838, %840 : (!firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, !firrtl.uint<32>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<32>) -> !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %1341 = firrtl.bundlecreate %1340 : (!firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>) -> !firrtl.bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>
      firrtl.matchingconnect %exec2Reg, %1341 : !firrtl.bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>
      %1342 = firrtl.bundlecreate %1337, %928, %930 : (!firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      %1343 = firrtl.bundlecreate %1338, %1040, %1042 : (!firrtl.bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>
      firrtl.matchingconnect %_exec3Reg_WIRE, %3 : !firrtl.bundle<exec2Signals: bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>>
      %1344 = firrtl.bundlecreate %1342, %932, %934, %936, %938 : (!firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, !firrtl.uint<32>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<32>) -> !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      %1345 = firrtl.bundlecreate %1344 : (!firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>) -> !firrtl.bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>
      %1346 = firrtl.bundlecreate %1345 : (!firrtl.bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>) -> !firrtl.bundle<exec2Signals: bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>>
      firrtl.matchingconnect %exec3Reg, %1346 : !firrtl.bundle<exec2Signals: bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>>
      %1347 = firrtl.bundlecreate %1343, %1044, %1046, %1048, %1050 : (!firrtl.bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, !firrtl.uint<32>, !firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<32>) -> !firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>
      firrtl.matchingconnect %_wbReg_WIRE, %0 : !firrtl.bundle<exec3Signals: bundle<exec2Signals: bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>>>
      %1348 = firrtl.bundlecreate %1347 : (!firrtl.bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>) -> !firrtl.bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>
      %1349 = firrtl.bundlecreate %1348 : (!firrtl.bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>) -> !firrtl.bundle<exec2Signals: bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>>
      %1350 = firrtl.bundlecreate %1349 : (!firrtl.bundle<exec2Signals: bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>>) -> !firrtl.bundle<exec3Signals: bundle<exec2Signals: bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>>>
      firrtl.matchingconnect %wbReg, %1350 : !firrtl.bundle<exec3Signals: bundle<exec2Signals: bundle<exec1Signals: bundle<regReadSignals: bundle<dispatchSignals: bundle<decodePipelineSignals: bundle<fetchSignals: bundle<valid: uint<1>, threadId: uint<3>, pc: uint<32>, instr: uint<32>>, decodeSignals: bundle<isALU: uint<1>, isLoad: uint<1>, isStore: uint<1>, isBranch: uint<1>, isJAL: uint<1>, isJALR: uint<1>, isLUI: uint<1>, isAUIPC: uint<1>, isSystem: uint<1>, isFence: uint<1>, usesImm: uint<1>, rs1: uint<5>, rs2: uint<5>, rd: uint<5>, aluOp: uint<5>, imm: uint<32>>>>, rs1Data: uint<32>, rs2Data: uint<32>>, result: uint<32>, doRegFileWrite: uint<1>, ctrlTaken: uint<1>, ctrlTarget: uint<32>>>>>
    }
  }
}
