...
- `../.venv/physical_design/` – default generated output from the OpenLane2 flow.
...
## Requirements & Tips
- `jq`, `nix-shell`, and an OpenLane2 checkout (default `../.venv/tools/skywater-pdk/openlane2`).
